...
function reemplaza_caracteres($dato){
	echo $dato."<br />";
		//$dato_arregla = str_replace("*"," ",$dato);
...
$grupo_compra = $row[410].$row[411].$row[412].$row[413].$row[414].$row[415].$row[416].$row[417].$row[418].$row[419].$row[420].$row[421].$row[422].$row[423].$row[424].$row[425].$row[426].$row[427];
$org_compras = $row[428].$row[429].$row[430].$row[431];
$monped = $row[432].$row[433].$row[434].$row[435].$row[436];
$monto_pedido = $row[437].$row[438].$row[439].$row[440].$row[441].$row[442].$row[443].$row[444].$row[445].$row[446].$row[447].$row[448].$row[449].$row[450].$row[451].$row[452].$row[453].$row[454];
$valor_usd =    $row[455].$row[456].$row[457].$row[458].$row[459].$row[460].$row[461].$row[462].$row[463].$row[464].$row[465].$row[466].$row[467].$row[468].$row[469].$row[470].$row[471].$row[472];
$trm_pedido =   $row[473].$row[474].$row[475].$row[476].$row[477].$row[478].$row[479].$row[480].$row[481].$row[482].$row[483].$row[484].$row[485].$row[486].$row[487].$row[488].$row[489].$row[490];
$valor_usd = str_replace(",",".",$valor_usd);
$monto_pedido = str_replace(",",".",$monto_pedido);
$trm_pedido = str_replace(",",".",$trm_pedido);
$mat_proveedor = $row[491].$row[492].$row[493].$row[494].$row[495].$row[496].$row[497].$row[498].$row[499].$row[500].$row[501].$row[502].$row[503].$row[504].$row[505].$row[506].$row[507].$row[508].$row[509].$row[510].$row[511].$row[512].$row[513].$row[514].$row[515].$row[516].$row[517].$row[518].$row[519].$row[520].$row[521].$row[522].$row[523].$row[524].$row[525];
$mat_proveedor_imprime= $mat_proveedor;
$mat_proveedor = str_replace(" ","",$mat_proveedor);//solo los datos requeridos
$usu_creador =  $row[526].$row[527].$row[528].$row[529].$row[530].$row[531].$row[532].$row[533].$row[534].$row[535].$row[536].$row[537];
$nombre_us_creador = 
$row[538].$row[539].$row[540].$row[541].$row[542].$row[543].$row[544].$row[545].$row[546].$row[547].$row[548].$row[549].$row[550].$row[551].$row[552].$row[553].$row[554].$row[555].$row[556].$row[557].$row[558].$row[559].$row[560].$row[561].$row[562].$row[563].$row[564].$row[565].$row[566].$row[567].$row[568].$row[569].$row[570].$row[571].$row[572].$row[573].$row[574].$row[575].$row[576].$row[577].$row[578].$row[579].$row[580].$row[581].$row[582].$row[583].$row[584].$row[585].$row[586].$row[587].$row[588].$row[589].$row[590].$row[591].$row[592].$row[593].$row[594].$row[595].$row[596].$row[597].$row[598].$row[599].$row[600].$row[601].$row[602].$row[603].$row[604].$row[605].$row[606].$row[607].$row[608].$row[609].$row[610].$row[611].$row[612].$row[613].$row[614].$row[615].$row[616].$row[617];
$ind_liberacion = $row[618];
$usu_aprobador = $row[619].$row[620].$row[621].$row[622].$row[623].$row[624].$row[625].$row[626].$row[627].$row[628].$row[629].$row[630];
$usu_aprobador = str_replace(" ","",$usu_aprobador);//solo los datos requeridos
$nombre_usu_aprobador = $row[631].$row[632].$row[633].$row[634].$row[635].$row[636].$row[637].$row[638].$row[639].$row[640].$row[641].$row[642];

echo "<br /><br /><br /><br /><strong>Nombre del Archivo:</strong> $archivo_completo  <br />";
echo " max (10)&nbsp;&nbsp;&nbsp;&nbsp;- cuantos ".strlen($doc_compra)             ." - &nbsp;&nbsp;&nbsp;&nbsp;doc_compra           - ".$doc_compra."<br />";
echo " max (10)&nbsp;&nbsp;&nbsp;&nbsp;- cuantos ".strlen($fecha_doc)              ." - &nbsp;&nbsp;&nbsp;&nbsp;fecha_doc            - ".$fecha_doc."<br />";
echo " max (4)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- cuantos ".strlen($cla_doc)                ." - &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;cla_doc              - ".$cla_doc."<br />";
echo " max (16)&nbsp;&nbsp;&nbsp;&nbsp;- cuantos ".strlen($nit_proveedor_imprime)          ." - &nbsp;&nbsp;&nbsp;&nbsp;nit_proveedor        - ".$nit_proveedor_imprime."<br />";
echo " max (35)&nbsp;&nbsp;&nbsp;&nbsp;- cuantos ".strlen($nombre_proveedor)       ." - &nbsp;&nbsp;&nbsp;&nbsp;nombre_proveedor     - ".$nombre_proveedor."<br />";
echo " max (255)&nbsp;&nbsp;- cuantos ".strlen($descripcion_pedido)     ." - descripcion_pedido   - &nbsp;&nbsp;".$descripcion_pedido."<br />";
echo " max (80)&nbsp;&nbsp;&nbsp;&nbsp;- cuantos ".strlen($gte_contrato)           ." - &nbsp;&nbsp;&nbsp;&nbsp;gte_contrato         -".$gte_contrato."<br />";
echo " max (18)&nbsp;&nbsp;&nbsp;&nbsp;- cuantos ".strlen($grupo_compra)           ." - &nbsp;&nbsp;&nbsp;&nbsp;grupo_compra         - ".$grupo_compra."<br />";
echo " max (4) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- cuantos ".strlen($org_compras)            ." - &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;org_compras          - ".$org_compras."<br />";
echo " max (5) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- cuantos ".strlen($monped)                 ." - &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;monped               - ".$monped."<br />";
echo " max (18)&nbsp;&nbsp;&nbsp;&nbsp;- cuantos ".strlen($monto_pedido)           ." - &nbsp;&nbsp;&nbsp;&nbsp;monto_pedido         - ".$monto_pedido."<br />";
echo " max (18)&nbsp;&nbsp;&nbsp;&nbsp;- cuantos ".strlen($valor_usd)              ." - &nbsp;&nbsp;&nbsp;&nbsp;valor_usd            - ".$valor_usd."<br />";
echo " max (18)&nbsp;&nbsp;&nbsp;&nbsp;- cuantos ".strlen($trm_pedido)             ." - &nbsp;&nbsp;&nbsp;&nbsp;trm_pedido           - ".$trm_pedido."<br />";
echo " max (35)&nbsp;&nbsp;&nbsp;&nbsp;- cuantos ".strlen($mat_proveedor_imprime)          ." - &nbsp;&nbsp;&nbsp;&nbsp;mat_proveedor        - ".$mat_proveedor_imprime."<br />";
echo " max (12)&nbsp;&nbsp;&nbsp;&nbsp;- cuantos ".strlen($usu_creador)            ." - &nbsp;&nbsp;&nbsp;&nbsp;usu_creador          - ".$usu_creador."<br />";
echo " max (80)&nbsp;&nbsp;&nbsp;&nbsp;- cuantos ".strlen($nombre_us_creador)      ." - &nbsp;&nbsp;&nbsp;&nbsp;nombre_us_creador    - ".$nombre_us_creador."<br />";
echo " max (1)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- cuantos ".strlen($ind_liberacion)         ." - &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ind_liberacion       - ".$ind_liberacion."<br />";
echo " max (12)&nbsp;&nbsp;&nbsp;&nbsp;- cuantos ".strlen($usu_aprobador)          ." - &nbsp;&nbsp;&nbsp;&nbsp;usu_aprobador        - ".$usu_aprobador."<br />";
echo " max (12)&nbsp;&nbsp;&nbsp;&nbsp;- cuantos ".strlen($nombre_usu_aprobador)   ." - &nbsp;&nbsp;&nbsp;&nbsp;nombre_usu_aprobador - ".$nombre_usu_aprobador."<br />";
...
echo "select count(*) from t2_servicios_menores_sap where estado = 1 and doc_compra = '".$doc_compra."' and monped = '".$monped."' and monto_pedido = ".$monto_pedido." and valor_usd = ".$valor_usd." and mat_proveedor = '".$mat_proveedor."' and ind_liberacion = '".$ind_liberacion."' and usu_aprobador = '".$usu_aprobador."'";

$buscar = traer_fila_row(query_db("select count(*) from t2_servicios_menores_sap where estado = 1 and doc_compra = '".$doc_compra."' and monped = '".$monped."' and monto_pedido = ".$monto_pedido." and valor_usd = ".$valor_usd." and mat_proveedor = '".$mat_proveedor."' and ind_liberacion = '".$ind_liberacion."' and usu_aprobador = '".$usu_aprobador."'"));

if($buscar[0] == 0){//sI NO ES DE LOS QUE SE REPITEN CADA 15 MINUTOS

	$update = query_db("update t2_servicios_menores_sap set estado = 2 where doc_compra = '".$doc_compra."'");
	/*Busca el id del nit*/
		$sel_proveedor = traer_fila_row(query_db("select * from t1_proveedor where replace(replace(replace(replace(nit, ' ', ''), ',', ''), '.', ''), '-', '') = '".$nit_proveedor."' and estado = 1"));
	if($sel_proveedor[0] <= 0 or $sel_proveedor[0] == ''){ // busca quitandole el DV al nit de SAP
		$sel_proveedor = traer_fila_row(query_db("select * from t1_proveedor where replace(replace(replace(replace(nit, ' ', ''), ',', ''), '.', ''), '-', '') = '".substr ($nit_proveedor, 0, strlen($nit_proveedor) - 1)."' and estado = 1"));
	}
	if($sel_proveedor[0] <= 0 or $sel_proveedor[0] == ''){ // si no se encintro ingresa 0
	$id_provee_sgpa =0;
	}else{
	$id_provee_sgpa = $sel_proveedor[0];
	}
	/*FIN Busca el id del nit*/
	/*busca id item*/
	$explode_num_item = explode("-",$mat_proveedor);
	$ano_item = $explode_num_item[0][2].$explode_num_item[0][3];
	...
	/* fin busca id item*/
	$insert = query_db("insert into t2_servicios_menores_sap (id_proveedor, id_item, nombre_archivo, doc_compra, fecha_doc, cla_doc, nit_proveedor, nombre_proveedor, descripcion_pedido, gte_contrato, grupo_compra, org_compras, monped, monto_pedido, valor_usd, trm_pedido, mat_proveedor, usu_creador, nombre_us_creador, ind_liberacion, usu_aprobador, nombre_usu_aprobador, estado) values (".$id_provee_sgpa.", ".$id_item.", '".$archivo_completo."' , '".$doc_compra."' , '".$fecha_doc."' , '".$cla_doc."' , '".$nit_proveedor."' , '".$nombre_proveedor."' , '".$descripcion_pedido."' , '".$gte_contrato."' , '".$grupo_compra."' , '".$org_compras."' , '".$monped."' , '".$monto_pedido."' , '".$valor_usd."' , '".$trm_pedido."' , '".$mat_proveedor."' , '".$usu_creador."' , '".$nombre_us_creador."' , '".$ind_liberacion."' , '".$usu_aprobador."' , '".$nombre_usu_aprobador."' , 1)");
	


}// FIN sI NO ES DE LOS QUE SE REPITEN CADA 15 MINUTOS
$activa_elimianr = "SI";		
...
fclose ( $fp ); 
		if($activa_elimianr == "SI"){ 
			$eliminar_archivo_trm = unlink($dir."/".$archivo_completo);
		}
...
while($sel_ap = traer_fila_db($sele_item_aprobados)){
	...
	$sel_secu = query_db("select * from t2_agl_secuencia_solicitud where id_item_pecc = ".$sel_ap[0]." and id_rol in (9,20,35, 45, 43, 48) and estado = 1 and tipo_adj_permiso=".$tipo_adj_permiso);
	while($sel_s = traer_fila_db($sel_secu)){
		...
		$sel_secu_si_director = traer_fila_row(query_db("select count(*) from t2_agl_secuencia_solicitud where id_item_pecc = ".$sel_ap[0]." and id_rol in (43, 48) and estado = 1 and tipo_adj_permiso=".$tipo_adj_permiso));		
		$entra_accion = "NO";		
		if($sel_s[2] == 20 or $sel_s[2] == 43 or $sel_s[2] == 48){$entra_accion = "SI";} // si es el vicepresindente entra de una por que es el ultimo aprobador
...
/*PUESTA EN FIRME DE LAS SOLICITUDES*/
//$sql="select id_item from t2_item_pecc where fecha_en_firme = '' or fecha_en_firme is null";
$sql = "select id_item, estado, t1_tipo_proceso_id from t2_item_pecc where estado <=20 or estado =31 or (fecha_en_firme = '' or fecha_en_firme is null) ";

echo $sql;

$sel_item_no_aprobados =query_db($sql);//se seleccionan todos los procesos que deberian tener fecha de puesta en firme
while ($sel_sol = traer_fila_db($sel_item_no_aprobados)){
	if($sel_sol[1]==31 or ($sel_sol[1]==14 and $sel_sol[2]==6)){
		$fecha_en_firme ="";
		}else{
			$fecha_en_firme = fecha_en_firme($sel_sol[0]);
		}
	$update = query_db("update t2_item_pecc set fecha_en_firme = '".$fecha_en_firme."' where id_item =  ".$sel_sol[0]);
	}

/*PUESTA EN FIRME DE LAS SOLICITUDES*/


/*actualizacion de reemplazos*/

$sel_remplazos = query_db("update tseg_reemplazos  set estado = 2 WHERE (estado = 1) and hasta_cuando < '".$fecha."'");
/**/

/*
$sel_contratos = query_db("select gerente, id from t7_contratos_contrato ");
while($sel_c = traer_fila_db($sel_contratos)){
	$insert = query_db("insert into t7_contratos_modica_gerente (id_gerente, id_modifica, id_contrato, fecha_modifica) values ('".$sel_c[0]."', '0', '".$sel_c[1]."', '2017-06-30')");
	}
*/
