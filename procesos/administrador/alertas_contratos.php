<?
	...
	$un_mes_dos =strtotime ( '+1 month' , strtotime ($fecha_actual) );
	$un_mes_dos=date('Y-m-d', $un_mes_dos);
	$dos_meses2 = strtotime ( '+2 month' , strtotime ($fecha_actual) );
	$dos_meses2=date('Y-m-d',$dos_meses2);
	$tres_meses2 = strtotime ( '+3 month' , strtotime ($fecha_actual) );
	$tres_meses2=date('Y-m-d',$tres_meses2);
	$cuatro_meses2 = strtotime ( '+4 month' , strtotime ($fecha_actual) );
	$cuatro_meses2=date('Y-m-d',$cuatro_meses2);
...
foreach ($destino as $v) {//PARA BUSCAR TODOS LOS CONTRATOS RELACIONADOS A UN USUARIO
	if($v!="" and $v!='--0'){
		...
		$cuenta1=traer_fila_row(query_db("select count(*) FROM t7_contratos_contrato where vigencia_mes between '$fecha_actual' and '$un_mes_dos' and vigencia_mes > '$fecha_actual' and (gerente=$v)"));
		if($cuenta1[0]!=0){
		$cont=0;
	...
	<tr>
		...
		$query=query_db("select * FROM t7_contratos_contrato where vigencia_mes between '$fecha_actual' and '$un_mes_dos' and vigencia_mes > '$fecha_actual' and (gerente=$v) order by vigencia_mes");
		...
		$un_mes_dos = strtotime ( '+1 day' , strtotime ($un_mes_dos) );
		$un_mes_dos=date('Y-m-d',$un_mes_dos);
		$cuenta1=traer_fila_row(query_db("select count(*) FROM t7_contratos_contrato where vigencia_mes between '$un_mes_dos' and '$dos_meses2' and vigencia_mes > '$fecha_actual' and (gerente=$v)"));
		if($cuenta1[0]!=0){
	...
	<tr>
		...
		$cuerpo_tabla2='';
		$cont=0;
		$query=query_db("select * FROM t7_contratos_contrato where vigencia_mes between '$un_mes_dos' and '$dos_meses2' and vigencia_mes > '$fecha_actual' and (gerente=$v) order by vigencia_mes");
		...
		$dos_meses2 = strtotime ( '+1 day' , strtotime ($dos_meses2) );
		$dos_meses2=date('Y-m-d',$dos_meses2);
		$cuenta1=traer_fila_row(query_db("select count(*) FROM t7_contratos_contrato where vigencia_mes between '$dos_meses2' and '$tres_meses2' and vigencia_mes > '$fecha_actual' and (gerente=$v)"));
		if($cuenta1[0]!=0){
	...
	<tr>
		...
		$cuerpo_tabla3='';
		$cont=0;
		$query=query_db("select * FROM t7_contratos_contrato where vigencia_mes between '$dos_meses2' and '$tres_meses2' and vigencia_mes > '$fecha_actual' and (gerente=$v) order by vigencia_mes");
		...
		$tres_meses2 = strtotime ( '+1 day' , strtotime ($tres_meses2) );
		$tres_meses2=date('Y-m-d',$tres_meses2);
		$cuenta1=traer_fila_row(query_db("select count(*) FROM t7_contratos_contrato where vigencia_mes between '$tres_meses2' and '$cuatro_meses2' and vigencia_mes > '$fecha_actual' and (gerente=$v)"));
		if($cuenta1[0]!=0){
	...
	<tr>
		...
		$cuerpo_tabla4='';
		$cont=0;
		$query=query_db("select * FROM t7_contratos_contrato where vigencia_mes between '$tres_meses2' and '$cuatro_meses2' and vigencia_mes > '$fecha_actual' and (gerente=$v) order by vigencia_mes");
