...
<script type="text/javascript" src="../librerias/js/procesos.js?act=14"></script>
...
<br />
  ...
  <tr>
    ...
    <table width="190px" border="0" align="left" cellpadding="2" cellspacing="2">
    <tr>
    ...
    <? if(($_SESSION["tipo_usuario"]!=4) && ($_SESSION["tipo_usuario"]!=10) or ($es_validador_abastecimiento == "SI") ){?>
      <tr>
        ...
        <td width="148" class="fondo_2" onClick="ajax_carga('nuevo-proceso.html','contenidos')"><div align="left">Crear proceso.</div></td>
      </tr>
    <? } ?>
...
if ( ($_SESSION["id_us_session"]==1) || ($_SESSION["id_us_session"]==18122)){?>      
      ...
      <tr>
        ...
        <td class="fondo_2" onClick="ajax_carga('../aplicaciones/index_reportes.php','contenidos')"><div align="left">Reportes</div></td>
      </tr>
