<? include("../../../librerias/lib/@session.php");
	...
	$busca_procesos = "select help_id, fecha, resuelto, nombre, razon_social, nombre_solicita,  cd_nombre, dp_nombre, ps_nombre, telefono, email, mensaje,  ip
                 from v_help_principal where  help_id = $id_soporte";
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <table width="95%" border="0" cellspacing="2" cellpadding="2">
    ...
    <td align="right"><label>
      <input name="button6" type="button" class="cancelar" id="button6" value="Volver al proceso" onClick="ajax_carga('mi_soporte_tecnico.html','contenidos')">
    </label></td>
  </tr>
</table>
<br>
            ...
            <table width="99%" border="0" cellpadding="2" cellspacing="2" class="tabla_borde_azul_fondo_blanco">
              ...
              <tr>
                ...
                <td><?=$sql_e[11];?>
                <input name="h_m_r" type="hidden" class="f_fechas" id="h_m_r"  onMouseDown="calendario_se('h_m_r')" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
...
<fieldset style="width:98%">
            ...
            <table width="98%" border="0" cellpadding="2" cellspacing="2" class="tabla_lista_resultados">
              <tr>
                <td width="28%" class="columna_titulo_resultados">Usuario</td>
                <td width="19%" class="columna_titulo_resultados">Fecha</td>
                <td width="53%" class="columna_titulo_resultados">Detalle gesti&oacute;n</td>
              </tr>
              
              <?
			  	$sele_car="select nombre_administrador, fecha, detallle, proxima_llamada from v_help_respuesta where help_id = $id_soporte order by fecha_respuesta desc";
