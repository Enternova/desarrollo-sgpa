...
<fieldset style="width:98%">
      <legend>Historico de preguntas</legend>
            <table width="98%" border="0" cellpadding="2" cellspacing="2" class="tabla_borde_azul_fondo_blanco">
              <tr>
                <td width="13%" class="titulo_tabla_azul_sin_bordes">Solicitado por</td>
                <td width="14%" class="titulo_tabla_azul_sin_bordes">Fecha del comunicado</td>
                <td width="13%" class="titulo_tabla_azul_sin_bordes">Fecha limite de respuesta</td>
                <td width="48%" class="titulo_tabla_azul_sin_bordes">Comunicado</td>
                <td width="12%" class="titulo_tabla_azul_sin_bordes">&nbsp;</td>
              </tr>
  ...
  ?>
          <tr class="<?=$class_g;?>">
            <td><?=$solicitante;?></td>
                ...
                <td><div align="center"><?=fecha_for_hora($ls_c[9]);?></div></td>
                <td><?=nl2br($ls_c[4]);?></td>
                <td>
                    <input name="ver_conte" type="button" class="buscar" onClick="ver_respuestas('div_for_<?=$ls_c[0];?>')" value="Ver detalle">                </td>
              </tr>
              ...
              <tr>
                ...
                <table width="95%" border="0" align="center" cellpadding="2" cellspacing="2" class="tabla_borde_azul_fondo_blanco">
                  ...
                  <tr>
                    <td colspan="3" id="div_for_pre_<?=$ls_c[0];?>">
...
<?
  ...
  ?>
           ...
           if( ($ls_c[9]=="") || ($ls_c[9] >= $fecha." ".$hora) ) { // si tiene apertura ?>
