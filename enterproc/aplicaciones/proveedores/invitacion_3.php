...
$id_invitacion = arreglo_recibe_variables($id_invitacion_pasa);
	...
	values ( ".$_SESSION["id_us_session"].", '$fecha $hora','', '".$_SERVER['REMOTE_ADDR']."', '','Modulo de criterios comerciales',$id_invitacion,".$_SESSION["id_proveedor"].")");
...
<table width="95%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td class="titulos_procesos"><?=$lenguaje_2;?>!</td>
  </tr>
</table>
...
//---------------------------------------------------------------------------------------------------------------
  ...
  <tr  onmouseover="this.className=&quot;tabla_menu_relover&quot;;" onMouseOut="this.className=&quot;&quot;;">
    ...
    <td align="center"><input name="button7" type="button" class="buscar" id="button7" value="Anexar documento" onClick="ajax_carga('oferta_invitacion_tecnica_<?=$id_invitacion_pasa;?>_<?=arreglo_pasa_variables($l_criterio[1]);?>_1.php','contenidos')"/></td>
  </tr>
  <? } // busca crirerios?>
  <? } ?>
</table>
