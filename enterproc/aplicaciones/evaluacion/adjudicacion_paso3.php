...
<table width="95%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    ...
    <td width="17%"><div align="left"><input name="button2" type="button" class="cancelar" id="button2" value="Volver  al resumen" onClick="ajax_carga('../aplicaciones/evaluacion/adjudicacion.php?id_invitacion=<?=$id_invitacion;?>','contenidos')"></div></td>
  </tr>
  <tr>
...
<table width="99%" border="0" cellpadding="1" cellspacing="1" class="tabla_lista_resultados">
  ...
  <tr class="<?=$class;?>">
    <td><?=$lp[3];?></td>
                <td><input type="button" name="button" class="buscar_ajustado" id="button" value="Ingresar " onClick="ajax_carga('../aplicaciones/evaluacion/adjudicacion_contactos_proceso.php?id_invitacion=<?=$id_invitacion;?>&pv_id_b=<?=$lp[2];?>','contenidos')"></td>
                <td><input type="button" name="button3" class="buscar_ajustado" id="button3" value="Ingresar" onClick="ajax_carga('../aplicaciones/evaluacion/adjudicacion_carta_terminos.php?id_invitacion=<?=$id_invitacion;?>&pv_id=<?=$lp[2];?>','contenidos')"></td>
                <td align="center"><strong><?=$cuenta_anexos[0];?></strong></td>
                <td><input type="button" name="button4" class="buscar_ajustado" id="button4" value="Anexar" onClick="ajax_carga('../aplicaciones/evaluacion/adjudicacion_anexos.php?id_invitacion=<?=$id_invitacion;?>&pv_id=<?=$lp[2];?>','contenidos')"></td>
  </tr>
              <? $num_fila++;} ?>
</table>
