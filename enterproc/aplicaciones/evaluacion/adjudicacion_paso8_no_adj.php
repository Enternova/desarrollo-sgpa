...
<table width="95%" border="0" align="center" cellpadding="2" cellspacing="2">
  <tr>
    ...
    <td width="17%"><div align="left"><input name="button2" type="button" class="cancelar" id="button2" value="Volver  al resumen" onClick="ajax_carga('../aplicaciones/evaluacion/<?=$ruta_vuelve;?>.php?id_invitacion=<?=$id_invitacion;?>&pv_id=<?=$pv_id;?>&id_notificacion=<?=$id_notificacion;?>','contenidos')"></div></td>
  </tr>
  <tr>
    <td >&nbsp;</td>
    <td>&nbsp;</td>
