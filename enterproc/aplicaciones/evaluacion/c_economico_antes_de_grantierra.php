...
//	$busca_valores_moneda_proveedor=traer_fila_row(query_db("select w_valor from $tabla_economica  where pv_id = $lista_oferentes[$yy] and evaluador5_id  = $l_campo[0] and evaluador4_id = $busca_campos_moneda[0] and oferta = 1"));
	$busca_lista_articulos = query_db("select * from $t95 where in_id = $id_invitacion  and pro11_id = $id_lista  $paginador,$numero_pagi ");
...
<tr>
     ...
     <tr class="administrador_tabla_titulo">
       <td width="26%"><div align="right"><strong>Seleccione la condici&oacute;n econ&oacute;mica:</strong></div></td>
       <td width="18%">
      ...
      <?
       ...
       <td width="25%"><div align="right"><strong>Parametro de selecci&oacute;n:</strong></div></td>
       <td width="12%"><select name="tipo_busq" id="tipo_busq" >
