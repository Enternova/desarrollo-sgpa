...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    ...
    <?=$sql_e[22];?></td>
    <td width="15%"><input name="button3" type="button" class="cancelar" id="button3" value="Volver  al resumen" onclick="ajax_carga('../aplicaciones/evaluacion/adjudicacion_paso3.php?id_invitacion=<?=$id_invitacion;?>','contenidos')"></td>
  </tr>
</table>
