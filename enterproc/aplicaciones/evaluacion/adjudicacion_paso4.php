...
<table width="95%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td width="83%" class="titulos_evaluacion">PASO 4: Confirmar adjudicaci&oacute;n y enviar notificaci&oacute;n a proveedores y usuarios de HOCOL S.A.</td>
...
<table width="99%" border="0" cellpadding="2" cellspacing="2" class="tabla_lista_resultados">
  ...
  <tr class="<?=$class;?>">
    ...
    <td><?=$lp[3];?><input type="hidden" name="nombre_provee_<?=$lp[2];?>" id="nombre_provee_<?=$lp[2];?>" value="<?=$lp[3];?>"></td>
                ...
                <td align="center"><img src="../imagenes/botones/editar_c.png"  title="Editar datos de adjudicación" alt="Editar datos de adjudicaci&oacute;n" width="16" height="16" longdesc="Editar datos de adjudicación" onClick="ajax_carga('../aplicaciones/evaluacion/adjudicacion_paso5.php?id_invitacion=<?=$id_invitacion;?>&pv_id=<?=$lp[2];?>','contenidos')"></td>
  </tr>
