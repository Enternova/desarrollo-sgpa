...
<br>
	...
	if($l_campo[3]=="Moneda") $busca_campos_moneda_lista=$l_campo[0];
		 ...
		 $sql_tabla.=" lista varchar(50) NOT NULL, item_ganador varchar(50) NOT NULL, pv_nombre text NOT NULL )  ";				
		$query_crea = query_db($sql_tabla);	
		
$sql_tabla="CREATE TEMPORARY TABLE reporte_temp_11 ( pv_id text NOT NULL,
		valor_unitario varchar(50) NOT NULL,valor_total varchar(50) NOT NULL, numero_ganadores varchar(50) NOT NULL,valior_ganafores varchar(50) NOT NULL ) " ;
		$query_crea = query_db($sql_tabla);
...
<tr>
     ...
     <td width="20%"><label>
         <input name="button" type="button" class="buscar" id="button" value="Generar Agrupamiento" onClick="ajax_carga('../aplicaciones/evaluacion/c_economico4.php?id_invitacion=<?=$id_invitacion;?>&pv_id=<?=$lc[4];?>&campo_valos=' + document.principal.campo_valos.value + '&tipo_busq=' + document.principal.tipo_busq.value + '&id_lista=<?=$id_lista;?>','carga_resultados_principales')">
       </label></td>
     </tr>
</table>
   <br>
