...
<table width="95%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td width="83%" class="titulos_evaluacion">PASO 2: Confirmar adjudicaci&oacute;n y enviar notificaci&oacute;n a proveedores y usuarios de HOCOL S.A.</td>
    <td width="17%"><div align="left">
      <input name="button3" type="button" class="cancelar" id="button3" value="Volver  al resumen" onClick="ajax_carga('../aplicaciones/evaluacion/adjudicacion_servicios.php?id_invitacion=<?=$id_invitacion;?>','contenidos')">
    </div></td>
  </tr>
  <tr>
...
<table width="99%" border="0" cellpadding="2" cellspacing="2" class="tabla_lista_resultados">
  <tr>
    <td colspan="3" class="columna_subtitulo_resultados"><strong>Proveedores adjudicados</strong></td>
  </tr>
  <tr>
    <td width="8%" class="columna_titulo_resultados"><strong>Notificado</strong></td>
    <td width="85%" class="columna_titulo_resultados"><div align="center"><strong>Nombre proveedor</strong></div></td>
    <td width="7%" class="columna_titulo_resultados"><div align="center"><strong>Resumen</strong></div></td>
  </tr>
  <?
  ...
  <tr class="<?=$class;?>">
    ...
    <td><?=$lp[3];?><input type="hidden" name="nombre_provee_<?=$lp[2];?>" id="nombre_provee_<?=$lp[2];?>" value="<?=$lp[3];?>"></td>
                <td align="center"><img src="../imagenes/botones/editar_c.png"  title="Editar datos de adjudicación" alt="Editar datos de adjudicaci&oacute;n" width="16" height="16" longdesc="Editar datos de adjudicación" onClick="ajax_carga('../aplicaciones/evaluacion/adjudicacion_paso5_servicios.php?id_invitacion=<?=$id_invitacion;?>&pv_id=<?=$lp[2];?>','contenidos')"></td>
  </tr>
...
<table width="99%" border="0" align="center" cellpadding="2" cellspacing="2">
  <tr>
    <td><div align="center"><input type="button" name="button" class="guardar" id="button" value="Enviar notificaci&oacute;n" onClick="canfirma_notificacion_js_SERVICIOS()"></div></td>
  </tr>
</table>
<p><br>
