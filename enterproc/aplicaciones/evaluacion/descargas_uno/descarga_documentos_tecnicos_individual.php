...
$carpeta_q=elimina_comillas_2_archivos($sql_proceso[0]."_tecnicos");
...
$busca_respo = query_db("select evaluador6_id, evaluador6_nombre,razon_social from ".$v10." where pro1_id = $evaluador1_id and termino = 2 and  pv_id = $pv_id   ");
