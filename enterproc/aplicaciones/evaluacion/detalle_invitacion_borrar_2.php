...
<table width="900" border="0" cellpadding="2" cellspacing="2" class="tabla_lista_resultados">
  <tr>
    <td><label>
        <div align="center">
          <input name="button6" type="button" class="guardar" id="button6" value="Ver / enviar aclaraciones finales del proceso" onClick="ajax_carga('../aplicaciones/evaluacion/cartelera_aclaraciones_finales.php?pasa=<?=arreglo_pasa_variables($id_invitacion);?>','carga_resultados_principales')">
        </div>
      </label></td>
  </tr>
</table>
