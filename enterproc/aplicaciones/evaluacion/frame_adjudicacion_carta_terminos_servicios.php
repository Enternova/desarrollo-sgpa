...
<body >
<form name="pr_frame" method="post" action="frame_adjudicacion_carta_terminos_servicios.php">

<table width="95%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td width="83%" class="titulos_evaluacion">Configure la carta de adjudicaci&oacute;n</td>
    <td width="17%"><div align="left"><input type="button" name="button" class="cancelar" id="button" value="Volver" onClick="window.parent.ajax_carga('../aplicaciones/evaluacion/adjudicacion_paso1_servicios.php?id_invitacion=<?=$id_invitacion;?>&campo_valos=<?=$campo_valos;?>','contenidos')"></div></td>
  </tr>
  <tr>
