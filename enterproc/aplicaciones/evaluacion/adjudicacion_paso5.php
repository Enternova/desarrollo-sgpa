...
<table width="95%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    ...
    <td width="17%"><div align="left"><input name="button2" type="button" class="cancelar" id="button2" value="Volver  al resumen" onClick="ajax_carga('../aplicaciones/evaluacion/adjudicacion_paso4.php?id_invitacion=<?=$id_invitacion;?>','contenidos')"></div></td>
  </tr>
  <tr>
