...
<table width="95%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td width="83%" class="titulos_evaluacion"><div align="left">CIERRE DEL PROCESO: <span class="telefono_contacto"><?=$sql_e[22];?></span></div>
      </td>
...
<table width="95%" border="0" cellpadding="2" cellspacing="2" class="tabla_lista_resultados">
  ...
  <tr class="filas_resultados">
    ...
    <td width="13%"><input onClick="ajax_carga('../aplicaciones/evaluacion/adjudicacion_paso1_sm.php?id_invitacion=<?=$id_invitacion;?>','contenidos')" type="button" name="button3" class="buscar_ajustado" id="button3" value="Ingresar al paso 1"></td>
  </tr>
  <tr>
    <td>2.</td>
    <td>Configure la carta de adjudicaci&oacute;n y los anexos por cada proveedor seleccionado</td>
    <td><input type="button" name="button5" class="buscar_ajustado" id="button5" value="Ingresar al paso 2" onClick="ajax_carga('../aplicaciones/evaluacion/adjudicacion_paso3_sm.php?id_invitacion=<?=$id_invitacion;?>','contenidos')"></td>
  </tr>
  <tr>
    <td class="filas_resultados">3.</td>
    ...
    <td class="filas_resultados"><input type="button" name="button6" class="buscar_ajustado" id="button6" value="Ingresar al paso 3" onClick="ajax_carga('../aplicaciones/evaluacion/adjudicacion_paso4_sm.php?id_invitacion=<?=$id_invitacion;?>','contenidos')"></td>
  </tr>
</table>
<br />
...
<table width="95%" border="0" cellpadding="2" cellspacing="2" class="tabla_lista_resultados">
  ...
  <tr>
    ...
    <td width="19%"><select name="b" id="b">
      <?=listas($tp1, " tp1_id not in(1,2,3,4,5,6,9) ",$sql_e[1],'nombre', 1);?>
      <?
