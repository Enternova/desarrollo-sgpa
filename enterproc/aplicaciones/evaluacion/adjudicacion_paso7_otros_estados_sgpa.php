...
<table width="95%" border="0" align="center" cellpadding="2" cellspacing="2">
  <tr>
    <td width="83%" class="titulos_secciones"><span class="titulos_resaltado_procesos_tarifas">RESUMEN DE NOTIFICACION OTROS ESTADOS</span></td>
...
<table width="95%" border="0" align="center" cellpadding="5" cellspacing="5">
  <tr>
    <td class="titulos_resaltado_procesos">Carta de <?=listas_sin_select($tp1,$sql_e[1],1);?></td>
  </tr>
</table>
<table width="95%" border="0" align="center" cellpadding="2" cellspacing="2" class="tabla_lista_resultados" >
  ...
  <tr>
    <td><p>Bogot&aacute;,
      ...
      <p>Cordial   Saludo,</p>
      <p>&nbsp;</p>
      <p align="justify">HOCOL S.A.   agradece su participaci&oacute;n en la invitaci&oacute;n de la referencia.  Le informamos que se decidi&oacute; que el proceso en referencia se diera como una
