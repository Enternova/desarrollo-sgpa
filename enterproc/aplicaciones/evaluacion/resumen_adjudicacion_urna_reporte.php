...
//$id_invitacion = arreglo_recibe_variables($id_invitacion_pasa);
	...
	echo $busca_procesos = "select * from $t5 where pro1_id = $id_p";
...
<table width="98%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    ...
    <td width="12%" align="right">
      <input name="button2" type="button" class="boton_volver" id="button2" value="Volver  al ITEM" onClick="ver_respuestas_adjudi('carga_detalle_reporte'); oculta_respuestas_adjudi('carga_detalle_adjudicacion')">
    </td>
  </tr>
</table>
<BR>
...
<table width="98%" border="0" cellpadding="2" cellspacing="2" class="tabla_lista_resultados">
  ...
  <tr class="<?=$class;?>">
    ...
    <td align="center"><img src="../imagenes/botones/editar_c.png"  title="Ver informaci&oacute;n detallada" alt="Ver informaci&oacute;n detallada" width="16" height="16" longdesc="Ver informaci&oacute;n detallada" onClick="ajax_carga('../aplicaciones/evaluacion/adjudicacion_paso6_reportes.php?id_invitacion=<?=$id_invitacion;?>&pv_id=<?=$lp[2];?>&id_notificacion=<?=$sql_ex_adjudicados[0];?>&pro27_id=<?=$lp[0];?>&id_item_pecc=<?=$id_item_pecc?>&id_tipo_proceso_pecc=<?=$id_tipo_proceso_pecc?>&aplica_log=no','carga_detalle_adjudicacion')"></td>
  </tr>
  <? $num_fila++;} ?>
</table>
