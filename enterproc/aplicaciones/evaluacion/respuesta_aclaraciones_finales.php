...
<table width="95%" border="0" cellpadding="2" cellspacing="2" class="tabla_borde_azul_fondo_blanco">
  <tr>
    <td colspan="3" class="titulos_procesos">DETALLE DE LA PREGUNTA ACLARATORIA</td>
  </tr>
  <tr>
    <td width="21%" class="tabla_sin_borde_fondo_gris"><div align="right"><strong>Asunto:</strong></div></td>
    <td colspan="2"><?=$busca_pregunta[6];?></td>
  </tr>
  <tr class="campos">
    <td class="tabla_sin_borde_fondo_gris"><div align="right"><strong>Pregunta:</strong></div></td>
    <td colspan="2" class="filas_resultados"><?=nl2br($busca_pregunta[7]);?></td>
  </tr>
  <tr>
    <td class="tabla_sin_borde_fondo_gris"><div align="right"><strong>Anexo:</strong></div></td>
    <td colspan="2"><? if($busca_pregunta[9]!=""){?>
  ...
  <tr>
    ...
    <td colspan="2"><?=fecha_for_hora($busca_pregunta[4]);?></td>
  </tr>
  <tr>
    <td class="tabla_sin_borde_fondo_gris"><div align="right"><strong>Fecha limite de respuesta:</strong></div></td>
    <td width="21%">
    <input name="h_m_r_modifica" type="text" class="f_fechas" id="h_m_r_modifica"  onmousedown="calendario_se('h_m_r_modifica')" value="<?=fecha_for_hora($busca_pregunta[5]);?>" /></td>
    <td width="58%"><input name="button" type="button" class="guardar" id="button" value="   Modificar fecha limite  " onClick="modifica_fecha_limite_final()"></td>
  </tr>
</table>
<br>
<table width="95%" border="0" cellpadding="3" cellspacing="3" class="tabla_borde_azul_fondo_blanco">
  ...
  <?
			...
			if($ext!="")
				{
					$nombre_adjunto = nombre_archivo_adjunto($lc[5]).".".$ext;//esta fila se reemplaza por el $lc[3] que esta en el link de descarga
					$doocumento_tipo ="<img src='../imagenes/mime/".$ext.".gif' title='Tipo Documento'>";
					$nombre_documento = $lc[5];
					$boton_descraga="<a href='javascript:void(0)'> <img src='../imagenes/botones/nuevo_1.png' title='descargar Documento' onclick='javascript:window.parent.location.href=\"../librerias/php/descarga_documentos_alcaraciones.php?id_invitacion=$id_invitacion&tipo_juri_tec=$tipo_juri_tec&n1=".$lc[0]."&n2=".$nombre_adjunto."\"'></a>";
				}
			else{
					$doocumento_tipo ="";
					$nombre_documento ="";
...
<table width='95%' border='0' cellpadding='2' cellspacing='2' class='tabla_borde_azul_fondo_blanco'>
  <tr>
    <td width='50%'><div align="center">
      <input name="button5" type="button" class="cancelar" id="button5" value="Volver  al resumen" onClick="ajax_carga('../aplicaciones/evaluacion/cartelera_aclaraciones_finales.php?pasa=<?=$id_invitacion_pasa;?>','carga_resultados_principales')">
    </div>
...
<p>
  ...
  <input type="hidden" name="id_pro"  value="<?=$busca_pregunta[2];?>">
