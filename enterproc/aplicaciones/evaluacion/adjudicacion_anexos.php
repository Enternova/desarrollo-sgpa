...
<table width="99%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    ...
    <td width="16%"><input name="button2" type="button" class="cancelar" id="button2" value="Volver  al resumen" onClick="ajax_carga('../aplicaciones/evaluacion/adjudicacion_paso3.php?id_invitacion=<?=$id_invitacion;?>','contenidos')"></td>
  </tr>
  <tr>
