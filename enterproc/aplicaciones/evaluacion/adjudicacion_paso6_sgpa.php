...
<table width="95%" border="0" align="center" cellpadding="2" cellspacing="2">
  <tr>
    <td width="83%" class="titulos_resaltado_procesos_tarifas">RESUMEN DE ADJUDICACION</td>
    <td width="17%"><div align="left"><input name="button2" type="button" class="boton_volver" id="button2" value="Volver  al resumen" onClick="ajax_carga('../enterproc/aplicaciones/evaluacion/resumen_adjudicacion_urna.php?id_p=<?=$id_invitacion;?>&id_item_pecc=<?=$id_item_pecc?>&id_tipo_proceso_pecc=<?=$id_tipo_proceso_pecc?>&aplica_log=no','contenidos')"></div></td>
  </tr>
  <tr>
...
<table width="95%" border="0" align="center" cellpadding="2" cellspacing="2" class="tabla_lista_resultados">
  ...
  <tr class="<?=$class;?>">
    ...
    <td><div align="center"><img src="../imagenes/botones/editar_c.png" width="16" height="16" alt="descargar documento" title="descargar documento" onClick="window.parent.location.href='../enterproc/librerias/php/descarga_documentos_adjudicacion_provedor.php?n1=<?=$lp[0];?>&n2=<?=$lp[3];?>'" /></div></td>
  </tr>
  <? $num_fila++;} ?>
</table>
<? } ?>
