...
<table width="98%" border="0">
  ...
  <tr>
    <td colspan="4" align="center"><input name="button" type="button" class="buscar" id="button" value="Realizar busqueda" onClick="javascript:busqueda_paginador_nuevo_varios_campos(1,'../aplicaciones/reporte_02.php','contenidos', '6')"></td>
  </tr>
</table>
<table width="98%" border="0" cellpadding="2" cellspacing="2" class="tabla_lista_resultados">
  <tr class="titulo_tabla_azul_sin_bordes">
    ...
    <td width="8%">Fecha visualizaci&oacute;n</td>
    <td width="9%"># d&iacute;as vencidos (visualizaci&oacute;n)</td>
  </tr>
  
  <?
  	$busca_lista_r1 = "select pro1_id,cd_id_entrega_documentos,consecutivo,nombre_administrador, documento,razon_social,fecha_envio,DATEDIFF('$fecha',fecha_envio), pro27_id,fecha_lectura from v_urna_reporte_adjudicacion_r1 where tp3_id = 1 and acepta_terminos = 0 $completo_sql  order by fecha_envio desc ";
    ...
    <td colspan="10"><div id="carga_obser_cierre_<?=$lista_r1[0];?>" style="display:none"  >
      ...
      <table width="98%" border="0">
        ...
        <tr>
          ...
          <td width="29%">
           estado_ad_<?=$lista_r1[8];?> <select name="estado_ad_<?=$lista_r1[8];?>" id="estado_ad_<?=$lista_r1[8];?>">
