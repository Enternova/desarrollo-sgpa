...
<table width="95%" border="0" cellspacing="3" cellpadding="3">
  ...
  <tr>
    ...
    <td><div align="right"><strong>Tipo de solicitud:</strong></div></td>
    <td><div align="left">
            ...
            <table width="98%" border="0" cellpadding="3" cellspacing="3" class="tabla_cronograma" >
              ...
              <tr class="campos_gris_cronograma">
                ...
                <td ><select name="responsable_tec" id="responsable_tec">
                  <?=listas_mayus($t1, " tipo_usuario <> 2 and tipo_usuario <> 10 and estado = 1 ",$busca_responsable_t[1],'nombre_administrador', 1);?>
                </select></td>
              </tr>
            ...
            <table width="99%" border="0" cellspacing="2" cellpadding="2">
             ...
             <? if ( ($sql_e[31]==1) && ($sql_e[2]==1) ){ ?>
              ...
              <tr>
                ...
                <td><input name="button10" type="hidden" class="buscar" id="button10" value="Crear proveedor" onclick="ajax_carga('../aplicaciones/crea_contactos_proveedor_emergencia.php?id_invitacion_pasa=<?=$id_proceso;?>','muestra_cootactos');ingresar_listado('oculta_todo_proveedores')" /></td>
                <td><div align="right">
