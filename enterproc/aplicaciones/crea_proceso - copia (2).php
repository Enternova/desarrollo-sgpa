...
<? if($sql_e[7]>=1) { echo listas_sin_select($tp3,$sql_e[3],1);
  ...
  ?>
  <tr>
    <td ><div align="right"><strong>Área Usuaria:</strong></div></td>
    <td><div align="left">
...
<fieldset style="width:98%">
            ...
            <table width="98%" border="0" cellpadding="3" cellspacing="3" class="tabla_cronograma" >
              ...
              <tr class="campos_blancos_cronograma">
                <td><div align="right"><strong>Fechas de Pertura y Cierre General:</strong></div></td>
                <td>&nbsp;</td>
      ...
      <? 
					if($_SESSION["pv_principal"] != 150)
						$traer_tecnicos_compras = " tipo_usuario <> 2 and tipo_usuario <> 10 and estado = 1 and  us_id IN (3, 4, 9, 18131, 20452, 21572, 21893, 21919, 22100, 22269, 22273)  ";
					elseif($_SESSION["pv_principal"] == 150)
						$traer_tecnicos_compras = " pv_principal = 150 ";
