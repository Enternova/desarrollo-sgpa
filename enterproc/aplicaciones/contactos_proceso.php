...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    ...
    <?=$sql_e[22];?></td>
    <td width="15%"><input name="button6" type="button" class="cancelar" id="button6" value="Volver al proceso" onClick="ajax_carga('../aplicaciones/crea_proceso.php?id_p=<?=$id_invitacion_pasa;?>','contenidos')"></td>
  </tr>
</table>
...
<br>
            ...
            <table width="99%" border="0" cellpadding="2" cellspacing="2" class="tabla_borde_azul_fondo_blanco">
              ...
              <tr>
                <td colspan="2">      
                  <div align="center">
                  <input name="button" type="button" class="guardar" id="button" value="Nuevo contacto" onClick="crea_nuevo_contacto()">                  </div></td>
              </tr>
            </table>
...
<fieldset style="width:98%">
  ...
  ?>
      <tr class="<?=$class_g;?>">
        ...
        <td><div align="center"><img src="../imagenes/botones/b_cancelar.gif" alt="Eliminar contacto" width="16" height="16" title="Eliminar contacto" onClick="elimina_contacto_todo(<?=$ls_c[0];?>)"></div></td>
      </tr>
...
<table width="98%" border="0">
  <tr>
    <td align="right"><input name="button2" type="button" class="guardar" id="button2" value="Enviar notificaci&oacute;n de proceso" onClick="notificar_nuevo_contacto()"></td>
  </tr>
</table>
<p>&nbsp;</p>
<p>
