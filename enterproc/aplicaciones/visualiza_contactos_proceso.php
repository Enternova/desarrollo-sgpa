...
<table width="99%" border="0" class="tabla_lista_resultados">
  ...
  <tr>
    <td width="24%" align="right" class="columna_subtitulo_resultados">Fecha de cierre:</td>
    <td width="19%"><input name="fecha_cierre_extratiempo" type="text" class="f_fechas" id="fecha_cierre_extratiempo" onMouseDown="calendario_se('fecha_cierre_extratiempo')" /></td>
    <td width="57%"><input type="hidden" name="anexos_s" id="anexos_s" /></td>
  </tr>
  <tr>
    <td align="right" valign="top" class="columna_subtitulo_resultados"><img src="../../enterproc/imagenes/botones/help.gif" width="18" height="18" alt="Ayuda"></td>
    <td colspan="2"><p>A continuaci&oacute;n debe registrar el n&uacute;mero de la solicitud y nivel de  aprobaci&oacute;n que autoriza la solicitud de oferta extempor&aacute;nea a este proveedor</p></td>
  </tr>
  <tr>
    <td align="right" valign="top" class="columna_subtitulo_resultados">N&uacute;mero de solicitud:</td>
    <td><input type="text" name="numero_aprobacion" id="numero_aprobacion"></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td align="right" valign="top" class="columna_subtitulo_resultados">Nivel de aprobaci&oacute;n:</td>
    <td><input type="text" name="nivel_aprobacion" id="nivel_aprobacion"></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td align="right" valign="top" class="columna_subtitulo_resultados">Comentarios de la solicitud de oferta extempor&aacute;nea a este proveedor:</td>
    <td colspan="2"><textarea name="observaciones_extratiempo" id="observaciones_extratiempo" cols="45" rows="5"></textarea></td>
  </tr>
  <tr>
    <td align="right" valign="top" class="columna_subtitulo_resultados">Detalle de la solicitud al Proponente (<span class="texto_paginador_proveedor">Este texto  en el cuerpo del email a que se enviara al proveedor</span>)</td>
    <td colspan="2"><textarea name="observaciones_extratiempo_cuerpo" id="observaciones_extratiempo_cuerpo" cols="45" rows="5"></textarea></td>
  </tr>
  <tr>
    <td align="right" valign="top">&nbsp;</td>
    <td colspan="2"><input name="button" type="button" class="guardar" id="button" value="        Guardar y notificar solicitud de oferta extempor&aacute;nea" onClick="crea_extratiempo()"></td>
  </tr>
</table>
...
<table width="99%" border="0" class="tabla_lista_resultados">
  <tr class="columna_titulo_resultados">
    <td colspan="6">Historico de solicitudes antes de apertura</td>
  </tr>
  <tr class="columna_titulo_resultados">
    <td width="12%">Creacion</td>
    <td width="14%">Usuario</td>
    <td width="14%">Fecha cierre ampliacion</td>
    <td width="14%">No. aprovaci&oacute;n</td>
    <td width="14%">Nivel aprobaci&oacute;n</td>
    <td width="60%">Comentarios</td>
  </tr>
  <?
  	 $sele_etx = "select fecha_creacion, nombre_administrador, fecha_cierre, anexo, obeservaciones,numero_aprobacion,nivel_aprobacion from v_urna_extratiempo where pro1_id = $id_invitacion and pv_id = $pv_id_b order by estado_extratiempo ";
