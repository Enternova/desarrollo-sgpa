...
';
  ...
  $busca_provee_adju = query_db("select pv_id from $v13 where pro1_id =  $id_invitacion and estado = 1 ");
	...
	$text.='<table width="100%" border="0" cellspacing="2" cellpadding="2" >
      ...
      <p>&nbsp;</p>
      <p><strong>REFERENCIA:   NO ADJUDICACION | CONSECUTIVO '.$arregla_conse.'
        </strong></p>
      <p>&nbsp;</p>
      <p>Cordial   Saludo,</p>
      <p>&nbsp;</p>
	  ...
	  $busca_provee_adju = query_db("select pv_id from $v13 where pro1_id =  $id_invitacion and estado = 1 ");
				...
				$busca_proveedor = traer_fila_row(query_db("select razon_social from pv_proveedores where pv_id = $lp[1]"));
							...
							$text.=' <tr>
								  ...
								  <p>&nbsp;</p>
								  <p><strong>REFERENCIA:   '.htmlentities(listas_sin_select($tp1,$linvi[1],1)).' | CONSECUTIVO '.$arregla_conse.'
									</strong></p>
								  <p>&nbsp;</p>
								  <p>Cordial   Saludo,</p>
								  <p>&nbsp;</p>
...
$pdf->Output('Acta_proceso_'.$consecutivo_proceso.'.pdf', 'D');
