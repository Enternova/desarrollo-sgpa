...
function escapeXML($strItem, $forDataURL) {
	...
	//Return
	$strItem = str_replace("á", "a", $strItem);
	$strItem = str_replace("é", "e", $strItem);
	$strItem = str_replace("í", "i", $strItem);
	$strItem = str_replace("ó", "o", $strItem);
	$strItem = str_replace("ú", "u", $strItem);
	$strItem = str_replace("Á", "A", $strItem);
	$strItem = str_replace("É", "E", $strItem);
	$strItem = str_replace("Í", "I", $strItem);
	$strItem = str_replace("Ó", "O", $strItem);
	$strItem = str_replace("Ú", "U", $strItem);
	$strItem = str_replace("ñ", "n", $strItem);
	$strItem = str_replace("Ñ", "N", $strItem);
