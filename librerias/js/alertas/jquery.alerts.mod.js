...
(function($) {
	...
	$.alerts = {
		...
		_show: function(title, msg, value, type, callback) {
			...
			switch( type ) {
				case 'alert':
					$("#popup_message").after('<div id="popup_panel"><input type="button" value="' + $.alerts.okButton + '" id="popup_ok"  class="solo_alertas" /></div>');
				...
				break;
				case 'confirm':
					$("#popup_message").after('<div id="popup_panel"><input type="button" value="' + $.alerts.okButton + '" id="popup_ok" class="confirmar_alertas" /> <input type="button" value="' + $.alerts.cancelButton + '" id="popup_cancel"  class="confirmar_alertas_error" /></div>');
					$("#popup_ok").click( function() {
						$.alerts._hide();
