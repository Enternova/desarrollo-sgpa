...
function elimina_criterio_admin(id, actviva_alerta){
	if(actviva_alerta==''){
		window.parent.muestra_alerta_general_solo_texto('elimina_criterio_admin(-comillas-'+id+'-comillas-,-comillas-12-comillas-)', 'Advertencia','*Seguro de Eliminar Este Criterio?', 40, 10, 12);
		return;
	}
	var forma = window.parent.document.principal;
	/**** SE UTILIZA ESTE METODO PORQUE EL MÓDULO ESTÁ DENTRO DE UN IFRAME ****/
...
function elimina_aspecto_admin(id, actviva_alerta){
	if(actviva_alerta==''){
		window.parent.muestra_alerta_general_solo_texto('elimina_aspecto_admin(-comillas-'+id+'-comillas-,-comillas-12-comillas-)', 'Advertencia','*Seguro de Eliminar Este Aspecto?', 40, 10, 12);
		return;
	}
	var forma = window.parent.document.principal;
	/**** SE UTILIZA ESTE METODO PORQUE EL MÓDULO ESTÁ DENTRO DE UN IFRAME ****/
