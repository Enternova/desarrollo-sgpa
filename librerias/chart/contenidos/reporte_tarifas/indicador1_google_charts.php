...
<body onload="$('#boton1_sub1').css('display', 'none');$('#boton2_sub1').css('display', 'none');">
	...
	<div class="row">
		...
		<div class="input-field col s12 m6 l6 right " id="boton1_sub1">
			...
			<a onclick="abrir_ventana('../../../../aplicaciones/reportes/reporte_variaciones_global_excel.php?tp_grafica=area1_sub1')" class="waves-effect waves-light btn" style="background-color: #229BFF; margin-top: 10% !important;" id=""><i class="material-icons left">&#xE2C0;</i>Descargar Soporte a Excel</a>-->
		</div>
	</div>
