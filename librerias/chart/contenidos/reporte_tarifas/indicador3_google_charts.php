...
$sql="select id_gerente, gerente from v_reporte_general_variacion_tarifas ".$_SESSION["comple_filtro"]."  group by id_gerente, gerente order by gerente";
...
while($sel_pro = traer_fila_db($selec_t_pro)){
	...
	$sql_barra_1 = traer_fila_row(query_db("select count(distinct  id_contrato_tarifas) from v_reporte_general_variacion_tarifas ".$_SESSION["comple_filtro"]." and  id_gerente = ".$sel_pro[0]." and t6_tarifas_estados_contratos_id <> 6"));
	...
	$sql_barra_2 = traer_fila_row(query_db("select count(distinct  id_contrato_tarifas) from v_reporte_general_variacion_tarifas ".$_SESSION["comple_filtro_exepcion"]." and id_gerente = ".$sel_pro[0]." and t6_tarifas_estados_contratos_id = 6"));
	...
	$cart.=str_replace(",", " ", $sel_pro[1]) .",".$sql_barra_1[0].",".$sql_barra_2[0].",".$sel_pro[0].",--,--";
}
...
<head>
	...
	<script>
		...
		function nivel_sub1(id){//éste se ejecuta para la columna número 1
			id=id.replace(" ", ", ")//se quitan los espacios para que no halla problemas para pasarlos por post
			...
			$.post('indicador1_sub1_google_charts.php', {gerente: id}, function(data5) {//se pasa por post la variable para esperar la respuesta con los datos para armar la otra gráfica
		...
		function nivel_sub2(text, col){//éste se ejecuta para la columna número 1
			...
			//alert(text+"----"+col)
			$.post('indicador1_sub2_google_charts.php', {categoria: text, usadas: col, tp_grafica: 2}, function(data6) {//se pasa por post la variable para esperar la respuesta con los datos para armar la otra gráfica
		...
		function abre_ventana_excel(grafica,columna){
...
<body onload="$('#boton1_sub1').css('display', 'none');$('#boton2_sub1').css('display', 'none');">
	<div class="row">
		<div class="input-field col col s12 m6 l6 left">
			<div class="titulos_secciones font" style="font-size:18pt !important; font-weight: 900 !important;"><br>N&uacute;mero de Contratos por Gerente de Contrato<?=$_SESSION["titulo_filtro3"];?> <?=ayuda_alerta_pequenaaling_izq_in_iframe("Para ver el detalle de esta gr&aacute;fica, de un click en cualquiera de las barras Verdes (Contratos sin Exepci&oacute;n) y a continuaci&oacute;n en la parte inferior a esta se abrir&aacute; una nueva gr&aacute;fica. ");?></div>
			...
			<a onclick="abrir_ventana('../../../../aplicaciones/reportes/reporte_variaciones_global_excel.php?tp_grafica=gerente1')" class="waves-effect waves-light btn" style="background-color: #229BFF; margin-top: 10% !important;"><i class="material-icons left">&#xE2C0;</i>Descargar Soporte a Excel</a>
		</div>
	...
	<div class="row">
		...
		<div class="input-field col s12 m6 l6 right " id="boton1_sub1">
			...
			<a onclick="abrir_ventana('../../../../aplicaciones/reportes/reporte_variaciones_global_excel.php?tp_grafica=gerente1_sub1')" class="waves-effect waves-light btn" style="background-color: #229BFF; margin-top: 10% !important;" id=""><i class="material-icons left">&#xE2C0;</i>Descargar Soporte a Excel</a>--> 
		</div>
	</div>
	...
	<div id="sub_nivel_2" style="width: 98% !important; height: 1110px;" class="grafica"></div>
</body>
</html>
<?
...
<table width="90%" border="0" align="center" class="po_tabla_principal">
   <tr>
      <td><div class="font" style="font-size:16pt !important; font-weight: 900 !important; padding: 10px;"><br>ATENCION GRAFICA POR GERENTE DE CONTRATO: <br> <br>No se puede mostrar esta gr&aacute;fica porque debe filtrar por alguno de los siguientes criterios:<br><br>
		&nbsp;&nbsp;&nbsp;&#9679; Gerente de contrato<br>
		&nbsp;&nbsp;&nbsp;&#9679; Contrato<br>
		&nbsp;&nbsp;&nbsp;&#9679; Proveedor<br>
        &nbsp;&nbsp;&nbsp;&#9679; Tambi&eacute;n puede filtrar por una o M&aacute;ximo 3 &aacute;reas usuarias</div></td>
    </tr>
