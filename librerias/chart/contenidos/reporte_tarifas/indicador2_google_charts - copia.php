...
while($sel_pro = traer_fila_db($selec_t_pro)){
	...
	$sql_barra_2 = traer_fila_row(query_db("select count(distinct  id_contrato_tarifas) from v_reporte_general_variacion_tarifas where t1_proveedor_id = ".$sel_pro[0]." and t6_tarifas_estados_contratos_id = 6"));
...
<body onload="oculta_boton_sub1()">
	...
	<div id="nivel_1" style="width: 100% !important; height: 1100px; margin-left: 0%!important; margin-top: 0px !important;"></div>
	<div class="row">
		<div class="input-field col col s12 m6 l6 left">
	...
	<div id="sub_nivel_1" style="width: 100% !important; height: 600px; margin-left: 0%!important;"></div>
...
<body>
	<div class="font" style="font-size:16pt !important; font-weight: 900 !important;"><br><br>No se puede mostrar la gr&aacute;fica porque debe seleccionar el gerente de contrato o el contratista</div>
</body>
</html>
<?}
?>