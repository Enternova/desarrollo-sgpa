...
(function(window, document){
	...
	var hocolTables=function(){
		...
		hocolTables_methods={
	      ...
	      $("#load-registers").append('<label class="left">MOSTRANDO REGISTROS: 1 AL 9 DE '+tablePagination.total+'</label>');
			},
				...
				if(liElement.id=="after"){
					for(var i=1; i<=sizeUl-2; i++){
						if(ulParent.getElementsByTagName("li")[i].className=="color-blue-light-hocol"){
							...
							var iBefore1;
							var iActual1;
							var lastRegister=(parseInt(ulParent.getElementsByTagName("li")[iActual].id)*10)-parseInt(ulParent.getElementsByTagName("li")[iActual].id);
							var firstRegister=(lastRegister-9)+1;
							if(ulParent.getElementsByTagName("li")[iAfter].className=="color-blue-light-hocol" && iAfter>2){
								...
								if(lastRegister==tablePagination.last){
					...
					if(sizeUl>3 && tablePagination.first>0){
						...
						var lastRegister=((idFind)*10)-idFind;
						var firstRegister=lastRegister-9;
						$("#load-registers").empty();
						$("#load-registers").append('<label class="left">MOSTRANDO REGISTROS: '+(firstRegister+1)+' AL '+lastRegister+' DE '+tablePagination.total+'</label>');
						document.getElementById(liElement.id).className="color-blue-light-hocol"
						_.addPaginationArray(firstRegister,lastRegister,1,2,tablePagination.last,tablePagination.total,tablePagination.id)
					...
					if(sizeUl>3){
						...
						var lastRegister=((idFind)*10)-idFind;
						var firstRegister=lastRegister-9;
						if(idFind==tablePagination.last){
							lastRegister=tablePagination.total
						}
						$("#load-registers").empty();
						$("#load-registers").append('<label class="left">MOSTRANDO REGISTROS: '+(firstRegister+1)+' AL '+lastRegister+' DE '+tablePagination.total+'</label>');
						document.getElementById(liElement.id).className="color-blue-light-hocol"
						_.addPaginationArray(firstRegister,lastRegister,parseInt(liElement.id),0,tablePagination.last,tablePagination.total,tablePagination.id)
						_.changePagiantionArray(iBefore, iActual)
					...
					if(sizeUl>3){
						...
						ulParent.getElementsByTagName("li")[sizeUl-1].className="waves-effect color-blue-light-hocol-hover"
						for(var i=1; i<sizeUl-1; i++){
							if(ulParent.getElementsByTagName("li")[i].className=="color-blue-light-hocol" && parseInt(ulParent.getElementsByTagName("li")[i].id) < iActual){
								idFind=parseInt(ulParent.getElementsByTagName("li")[i].id)
								idFind++
							}
							if(ulParent.getElementsByTagName("li")[i].className=="color-blue-light-hocol" && parseInt(ulParent.getElementsByTagName("li")[i].id) > iActual){
								idFind=parseInt(ulParent.getElementsByTagName("li")[i].id)
						...
						$("#load-registers").empty();
						$("#load-registers").append('<label class="left">MOSTRANDO REGISTROS: '+(firstRegister+1)+' AL '+(lastRegister-1)+' DE '+tablePagination.total+'</label>');
						document.getElementById(liElement.id).className="color-blue-light-hocol"
						_.addPaginationArray(firstRegister,lastRegister,parseInt(liElement.id),parseInt(liElement.id)+1,tablePagination.last,tablePagination.total,tablePagination.id)
						_.changePagiantionArray(iBefore, iActual)
					}else{
						ulParent.getElementsByTagName("li")[0].className="disabled"
						ulParent.getElementsByTagName("li")[sizeUl-1].className="disabled"
			...
			changePagiantionArray:function(start, end){
				start=tablePagination.first; 
				end=tablePagination.after
				if(end > tablePagination.total ){
