...
if($_POST["accion"]=="aceptar_aprobacion_evaluacion"){
	...
	*/
	...
	if($tipo_evlauacion[0]==2 and $tipo_evlauacion[2]==4){
	...
	if($tipo_evlauacion[0]==2 and $tipo_evlauacion[2]==6){	
	...
	if($tipo_evlauacion[0]==3 and $tipo_evlauacion[2]==5){
	...
	if($tipo_evlauacion[0]==3 and $tipo_evlauacion[2]==7){
