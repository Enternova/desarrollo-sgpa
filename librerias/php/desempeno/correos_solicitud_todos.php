...
$result=traer_fila_row(query_db("select distinct fecha_inicio,razon_social,id_evaluador,id_documento from vista_t9_contratos_definicion_criterios2 where id_evaluacion=".$id_evaluacion));
