...
function envia_aprobacion_aspecto_puntual($id_evaluacion) {
...
$result9=traer_fila_row(query_db("select nombre_administrador,email from t1_us_usuarios where us_id='17'"));
	...
	$asunto="PENDIENTE APROBACION DE CRITERIOS CONTRATO PUNTUAL";
...
$query=query_db($select_tabla);
					...
					$mensaje_envio ='<html>
									<body>
										...
										el cual es gerenciado por el Sr(a). '.$nombre_gerente.'.Para realizar la evaluaci&oacute;n de desempe&ntilde;o del proveedor en el contrato ya mencionado, el Gerente del contrato estableci&oacute; 
										los criterios a continuaci&oacute;n, los cuales requieren su aprobaci&oacute;n para realizar la posterior evaluaci&oacute;n.</tr>
										</table>
									<br><br><br>
...
function envio_aprobacion_aspecto_proveedor_puntual($id_evaluacion) {
...
$result9=traer_fila_row(query_db("select nombre_administrador,email from t1_us_usuarios where us_id='17'"));
	...
	$asunto="CRITERIOS APROBADOS PARA EVALUACION CONTRATO PUNTUAL";
...
$query=query_db($select_tabla);
					...
					$mensaje_envio ='<html>
									<body>
										...
										<br>
										<table>
										<tr>El '.$fecha_inicio_contrato.' , se suscribi&oacute; con '.$nombre_proveedor.', el contrato '.$numero_documento.', para la prestaci&oacute;n del servicio de
...
function envia_aprobacion_evaluacion_puntual($id_evaluacion) {
	
$result=traer_fila_row(query_db("select distinct fecha_inicio_contrato,nombre_proveedor,numero_documento,convert(varchar(max), objeto),nombre_gerente,id_crea_aspectos,id_evaluador,id_jefe from vista_t9_contrato_puntual where id_evaluacion=".$id_evaluacion));
...
$result9=traer_fila_row(query_db("select nombre_administrador,email from t1_us_usuarios where us_id='17'"));
	...
	$asunto="PENDIENTE APROBACION DE EVALUACION TECNICA CONTRATO PUNTUAL";
...
function envia_aprobacion_proveedor_evaluacion_puntual($id_evaluacion) {
	
$result=traer_fila_row(query_db("select distinct fecha_inicio_contrato,nombre_proveedor,numero_documento,convert(varchar(max), objeto),nombre_gerente,id_crea_aspectos,id_evaluador,id_jefe,id_proveedor from vista_t9_contrato_puntual where id_evaluacion=".$id_evaluacion));
...
$result9=traer_fila_row(query_db("select nombre_administrador,email from t1_us_usuarios where us_id='17'"));
	...
	$asunto="RESULTADOS DE EVALUACION TECNICA CONTRATO PUNTUAL";
	...
	$nombre_emisor="ABASTECIMIENTO";	
					...
					$mensaje_envio ='<html>
									<body>
										...
										<table >
										<tr>Se ha realizado evaluaci&oacute;n del contrato N '.$numero_documento.' , suscrito con el proveedor '.$nombre_proveedor.',para el servicio de ('.$objeto.'),
										el cual es gerenciado por el Sr(a). '.$nombre_gerente.' . A continuaci&oacute;n se encuentra el resultado de su desempe&ntilde;o en la ejecuci&oacute;n del servicio. </tr>
										</table>
										<br>
										<table border="1">
										<tr bgcolor="#1F497D">
...
//CORREO ENVIO DE EVALUACION
function envia_aprobacion_evaluacion_puntual_hse($id_evaluacion) {
...
$result9=traer_fila_row(query_db("select nombre_administrador,email from t1_us_usuarios where us_id='17'"));
	...
	$asunto="PENDIENTE APROBACION DE EVALUACION HSSE CONTRATO PUNTUAL";
...
//CORREO ENVIO DE EVALUACION
function envia_aprobacion_evaluacion_puntual_adm($id_evaluacion) {
...
$result9=traer_fila_row(query_db("select nombre_administrador,email from t1_us_usuarios where us_id='17'"));
	...
	$asunto="PENDIENTE APROBACION DE EVALUACION ADMINISTRATIVA CONTRATO PUNTUAL";
...
//CORREO SOLICITUD ENVIO APROBACION PROVEEDOR
function envia_aprobacion_proveedor_evaluacion_hsse_puntual($id_evaluacion) {
...
$result9=traer_fila_row(query_db("select nombre_administrador,email from t1_us_usuarios where us_id='17'"));
	...
	$asunto="RESULTADOS DE EVALUACION HSSE CONTRATO PUNTUAL";
...
//CORREO SOLICITUD ENVIO APROBACION PROVEEDOR
function envia_aprobacion_proveedor_evaluacion_adm_puntual($id_evaluacion) {
...
$result9=traer_fila_row(query_db("select nombre_administrador,email from t1_us_usuarios where us_id='17'"));
	...
	$asunto="RESULTADOS DE EVALUACION ADMINISTRATIVA CONTRATO PUNTUAL";
