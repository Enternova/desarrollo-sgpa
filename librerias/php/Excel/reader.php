...
class Spreadsheet_Excel_Reader {
    ...
    */
    ...
    function read($sFileName) {
		global $ruta_devolucion,$ruta_imagenes;
...
<table width="90%" border="0" cellspacing="2" cellpadding="2" align="center">
  <tr> 
    <td class="titulosec"><img src="'.$ruta_imagenes.'Advertencia.gif" width="10" height="10"> 
      No se ha podido cargar el archivo </td>
  </tr>
  <tr> 
    <td class="bordetablaazul"><p>Revise lo siguente:</p>
      <ul>
        <li> El formato del archivo debe ser MS EXCEL </li>
        <li> No haber incluido puntos, comas, o signos $ en el campo de precio 
          de su oferta </li>
        <li>No haber eliminado o adicionado columnas en el archivo original que descargo </li>
      </ul>
      <hr width="80%">
    <p align="center"><a href="'.$ruta_devolucion.'">Volver</a></p></td>
  </tr>
  <tr> 
    <th><div align="center">Si requiere Ayuda en la utilizaci&oacute;n de esta 
        herramienta, puede ponerse en cont&aacute;cto con Aracniastudios Ltda 
      </div>
      <p align="center">Help Desk: (57 1) 6296774 - 6296122 Opci&oacute;n 2</p>
      <p align="center">Informaci&oacute;n y Ventas: (57 1) 6296122 Opci&oacute;n 
        3 <br>
      </p></th>
  </tr>
</table>');	
