...
$_GET["cuerpo_modal"] = str_replace("-ampersan-", "&", $_GET["cuerpo_modal"]);
...
<div class="jmgmodal visible" id="modal-alertas" >
	<div class="panel" style="max-height: <?=$alto_panel."%"?> !important">
		...
		<div class="footer" style="min-height: <?=$alto_footer."%"?> !important">
			...
			<button id="button-ok" class="action2 action-alert"  onclick='window.parent.document.getElementById("div_carga_busca_sol").style.display="none";window.parent.document.getElementById("cargando_pecc").style.display = "none"' style="background: #F44336 !important;">
