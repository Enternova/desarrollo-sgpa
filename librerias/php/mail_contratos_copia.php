...
//------------------------------------------------------
    $correo_emisor="jeison.rivera@enternova.net";     //Correo a utilizar para autenticarse
    $contrasena="RRRj@son12";
    $nombre_emisor="Notificaciones de Prueba HOCOL";               //Nombre de quien envía el correo
...
//--------------------------------------------------------
    ...
    //$mail->AddBCC("gtec-notificaciones@enternova.net","Notificaciones evidencia"); 
...
//--------------------------------------------------------
	...
	/*?><script>alert("Se envio el email de notificacion desde la cuenta: Emisor: <?=$nombre_emisor?>, <?=$emisor?> - para el correo: <?=$destino?>")</script><?*/
