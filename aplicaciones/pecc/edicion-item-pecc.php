...
?>
	...
	echo $sel_item_obs[6];
     ...
     <?
		...
		<tr>
			<td align="right" ></td>
			<td align="left" colspan="3"><p><img src="../imagenes/botones/icono_ayuda.png"></img>&nbsp;<span style="color: #229BFF; font-family: roboto; font-size: 11pt; font-weight: 900;">Por favor diligenciar la fecha de finalización de los trabajos, recuerde que esta no <br />
			</span><span style="color: #229BFF; font-family: roboto; font-size: 11pt; font-weight: 900;">debe ser superior a la fecha de finalización del contrato</span></p></td>
		</tr>
		<?
			}
		?>
