	  ...
	  while($sel_a_usuario = traer_fila_db($sel_areas)){
		...
		if($bus_area != 0){
			 if($bus_area == 34){
				  ...
				  $areas_in = $areas_in.", ".$bus_area.", 5,2,30,14";
				  }elseif($bus_area == 46){
...
<div id="div_contenidos_carga">
  ...
  <table width="99%" border="0" cellpadding="2" cellspacing="2">
    <tr>
      <td width="23%" align="right">Numero de la Solicitud:</td>
      <td width="6%">
      ...
      <option value="15" <? if($_GET["numero2_pecc"] == 15) echo "selected='selected'";?>> 15</option>
      ...
      <td width="48%" rowspan="13" align="right"><table width="99%" border="0" cellpadding="2" cellspacing="2">
        <tr>
    ...
    <tr>
      ...
      <option value="18245">SANABRIA, TATIANA</option>
      <option value="57">DELOITTE, AMPARO CARDENAS</option>
      <?
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <table width="100%" border="0" cellpadding="2" cellspacing="2" class="tabla_lista_resultados">
    ...
    <tr>
      ...
      <td width="11%" align="center" class="columna_subtitulo_resultados">Rol Pendiente para Firmar</td>      
...
$comple_est="";
  ...
  if($sel_para_insert[8]==6 and $sel_para_insert[0] <= 5393) $nom_tipo_proceso =  "Adjudicacion Directa Sondeo";
	...
	?>
    <tr class="<?=$clase?>">
      <td ><a href="javascript:ajax_carga('../aplicaciones/pecc/edicion-item-pecc.php?id_item_pecc=<?=$id_item?>&id_tipo_proceso_pecc=<?=$id_tipo_proceso_pecc?>','contenidos')"><img src="../imagenes/botones/alerta.png" alt="Proceso pendiente, sin resolver o sin leer" width="16" height="16" /></a></td>
