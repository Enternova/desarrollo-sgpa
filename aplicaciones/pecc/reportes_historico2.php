...
<tr >
  <td colspan="3" rowspan="3" align="center" >&nbsp;&nbsp;<img src="https://www.abastecimiento.hocol.com.co/sgpa/imagenes/coorporativo/logo-cliente.png" alt="" /></td>
...
<tr >
 ...
 <tr>
      <td width="5%" align="center" class="columna_subtitulo_resultados">Numero</td>
      <td width="8%" align="center" class="columna_subtitulo_resultados">Es carga Masiva</td>
      <td width="8%" align="center" class="columna_subtitulo_resultados">Fecha del Requerimiento</td>
      <td width="11%" align="center" class="columna_subtitulo_resultados">Tipo de Proceso</td>
      <td width="13%" align="center" class="columna_subtitulo_resultados">Fecha de Aprobacion</td>
      <td width="13%" align="center" class="columna_subtitulo_resultados">Nivel de Aprobacion</td>
      <td width="13%" align="center" class="columna_subtitulo_resultados">Contratos Relacionados</td>
      <td width="15%" align="center" class="columna_subtitulo_resultados">Usuario Solicitante</td>
      <td width="28%" align="center" class="columna_subtitulo_resultados">Objeto de la Solicitud</td>
      <td width="11%" align="center" class="columna_subtitulo_resultados">Areas del Usuario</td>
      <td width="11%" align="center" class="columna_subtitulo_resultados">Gerente de OT</td>
      <td width="11%" align="center" class="columna_subtitulo_resultados">Areas Gerente OT</td>
      <td width="11%" align="center" class="columna_subtitulo_resultados">Area Solicitud</td>      
      <td width="11%" align="center" class="columna_subtitulo_resultados">Estado</td>
      <td width="11%" align="center" class="columna_subtitulo_resultados">Comentario</td>
    </tr>
    <?php
$sele_items_historico_codigo = "select id_item, num1, num2, num3, fecha_se_requiere, nombre, objeto_solicitud, Expr1, t1_tipo_proceso_id, id_pecc, estado, id_us, id_us_profesional_asignado, t1_area_id, t1_tipo_contratacion_id, congelado,id_us_preparador,ROW_NUMBER()Over(order by id_item desc) As RowNum,solicitud_rechazada,solicitud_desierta,id_gerente_ot, de_historico from v_peec_historico where estado <> 34  $completar_filtros $comple_sql_histo $comple_sq_us and t1_area_id > 0 group by id_item, num1, num2, num3, fecha_se_requiere, nombre, objeto_solicitud, Expr1, t1_tipo_proceso_id, id_pecc, estado, id_us, id_us_profesional_asignado, t1_area_id,t1_tipo_contratacion_id, congelado,id_us_preparador,solicitud_rechazada,solicitud_desierta,id_gerente_ot, de_historico";
