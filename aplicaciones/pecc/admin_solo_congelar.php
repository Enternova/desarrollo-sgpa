    ...
    <td width="76%" valign="top"><table width="100%" border="0" align="center" class="tabla_lista_resultados">
      ...
      <tr>
        ...
        ?>
		 ...
		 ?>
            <tr class="<?=$clase?>">
              <td align="left" >5. Cambiar el Estado del Proceso
            ...
            <tr class="<?=$clase?>">
              <td align="center" >&nbsp;</td>
              <td colspan="2" align="center" ><input type="button" name="button2" id="button2" value="Grabar Cambios" class="boton_grabar" onclick="acciones_administrativas_solo_congela()" /></td>
            </tr>
