...
<br />
	...
	if($pagina<=1){//si no tiene pagina seleccionada
 	 ...
 	 $sql_cuenta2 = "select  count(*) from  $v_t_3 where tarifas_contrato_id = $id_contrato_arr  and t6_tarifas_estados_tarifas_id in (1,2,5) and t6_tarifas_listas_lista_id = $lista_existentes ";
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="2" cellpadding="2" class="tabla_paginador">
      <tr>
        ...
        <td width="8%">
          <select name="pagina" onchange="javascript:busqueda_paginador_nuevo(this.value,'../aplicaciones/tarifas/c_modificar_tarifas.php','carga_acciones_permitidas')">
            <? 
				...
				if($nobre_categori_impri!=$lista_detalle[2]){//si la categoria es una sola
					...
					<br />
                       <table width="98%" border="0">
                          <tr>
                            <td class="titulos_secciones" width="10%">Categorias: </td>
