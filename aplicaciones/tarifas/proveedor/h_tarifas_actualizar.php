...
$nobre_categori_impri="";
		...
		$nombre_gupo_imprime="";
	 	  ...
	 	  $busca_detalle = "select * from (
                      ...
                      us_aprobacion_actual, creada_luego_firme , ROW_NUMBER() OVER(ORDER BY categoria, grupo, tarifa_padre, fecha_creacion ) AS rownum from $v_t_3 where $where_general
								) as sub
						...
						/*$busca_atributos=query_db("select * from $t13 where t6_tarifas_listas_lista_id = $lista_existentes and estado = 1");
								...
								*/	
									...
									<table border=0 cellspacing="2" cellpadding="2" width="100%" >                	
											...
											<tr>
											  <th width="8%" class="fondo_3">&nbsp;</th>
											  <th width="3%" class="fondo_3">Origen</th>
											<th  width="3%" class="fondo_3">Codigo</th>
											<th  class="fondo_3" width="50%">Nombre_generico_del_producto_/_servicio</th>
											  
											  <th width="6%" class="fondo_3"><div align="center">Unidad </div></th>
											  <th width="5%" class="fondo_3">Moneda</th>
											  <th width="7%" class="fondo_3"><div align="center">Valor_tarifa</div></th>
											  <th width="7%" class="fondo_3">Inicio_vigencia</th>
											  <th width="5%" class="fondo_3">Modificada</th>
											  <th width="5%" class="fondo_3">Aprobaci&oacute;n</th>
											  <th class="fondo_3"  width="2%">Admin</th>
											  <?=$titulos_atributos;?>
											</tr>
...
$modificada ="";
                ...
                <table width="100%" border="0">
				 ...
				 ?>
                  ...
                  <tr>
                    ...
                    <?=listas($g1, " estado = 1 and tipo_usuario <> 2 and email like '%@hocol.com.co%'",$busca_secundarios[0],"nombre_administrador", 1);?>
                    </select>
 ...
 <? if($lista_detalle[13]!=3){//si esta pendiente de aprobacion ?>
  <tr>
    <td width="20%" ><div align="right"><strong>Anexo soporte:</strong></div></td>
  ...
  <tr>
    ...
    <input type="button" name="button4" class="boton_grabar" id="button4" value="Grabar modificaci&oacute;n" onclick="edita_tarifa('<?=arreglo_pasa_variables($lista_detalle[0]);?>',document.principal.valor_tarifa_<?=$lista_detalle[0];?>)"/>
   <? } ?>
    <? if($lista_detalle[13]==9){//si no esta en firme ?>
    <input type="button" name="button9" class="boton_grabar" id="button9" value="Editar modificaci&oacute;n" onclick="edita_tarifa('<?=arreglo_pasa_variables($lista_detalle[0]);?>',document.principal.valor_tarifa_<?=$lista_detalle[0];?>)"/>
    <input type="button" name="button9" class="boton_eliminar" id="button9" value="Eliminar modficaci&oacute;n" onclick="elimina_creacion_tarifa('<?=arreglo_pasa_variables($lista_detalle[0]);?>')"/>
   ...
   <? } ?>
    <? if($lista_detalle[13]!=3){//si esta pendiente de aprobacion ?>
    <input name="button8" type="button" class="boton_volver" id="button8" value="Cancelar modificaci&oacute;n" onclick="oculta_div_o('espacio_<?=$lista_detalle[0];?>')" />
   <? } ?></td>
    </tr>
</table>
