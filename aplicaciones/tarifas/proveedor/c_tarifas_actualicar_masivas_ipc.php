...
<table width="99%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td colspan="2" class="titulos_secciones_tarifas">SECCION:<span class="titulos_resaltado_procesos_tarifas"> MODIFICACION DE TARIFAS POR IPC MASIVAS &gt;&gt; CONTRATO:
  ...
  <tr>
    <td width="71%" valign="top"><br />
      <table width="98%" border="0" cellpadding="2" cellspacing="2" class="tabla_lista_resultados">
        <tr>
          <td colspan="4" class="fondo_2_sub"><strong >Modificar tarifas por IPC masivas PASO 1</strong></td>
        </tr>
        <tr>
          ...
          <td width="42%"><p>Cargue al sistema las tarifas de esta lista masivamente desde archivo excel siguiendo estos pasos:</p>
            <ul>
              <li><a href="javascript:void(0);" onclick="window.parent.location.href='../aplicaciones/tarifas/proveedor/expotar_plantilla_tarifas_actualizacion_ipc.php?id_contrato=<?=$id_contrato;?>&amp;lista_existentes=<?=$lista_existentes;?>'">Descargue aqu&iacute; la plantilla</a> </li>
...
<br />
      <table width="98%" border="0" cellpadding="2" cellspacing="2" class="tabla_lista_resultados">
	   ...
	   $ya_tiene_cargue = traer_fila_row(query_db("select count(*) from t6_tarifas_lista where tarifas_contrato_id = ".$id_contrato_arr." and t6_tarifas_estados_tarifas_id = 9 and tipo_creacion_modifica in (4)"));
	   ...
	   if($sql_con[19]==2){ //si es contrato marco ?>
        ...
        <tr>
          <td colspan="4" align="center" valign="top"><input type="button" name="button" class="boton_grabar" id="button" value="Presione este comando para cargar la plantilla" onclick="carga_tarifas_masivas_actualizacion_IPC('')" /></td>
        </tr>
        ...
        <tr>
          ...
          <td align="right" valign="top"><input type="button" name="button2" class="boton_buscar" id="button2" value="Ver el cargue previo" onclick="ajax_carga('../aplicaciones/tarifas/proveedor/v_tarifas_actualizar_masiva_ipc.php?id_contrato=<?=$id_contrato;?>&amp;lista_existentes=<?=$lista_existentes;?>&amp;tipo_creacion=2','carga_acciones_permitidas')" /></td>
	  ...
	  ?>
        ...
        <tr>
          <td colspan="4" align="center" valign="top"><input type="button" name="button3" class="boton_grabar" id="button3" value="Presione este comando para confirmar el cargue" onclick="confirma_actualizacion_masiva_ipc_c()" /></td>
        </tr>
        <?
	  }else{
...
<br />
 ...
 <? } //si ya selecciono una lista ?>
  ...
  <input type="hidden" name="tipo_creacion" value="5" />
