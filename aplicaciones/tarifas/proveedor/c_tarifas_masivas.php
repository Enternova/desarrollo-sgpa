...
$lista_existentes = $selec_lista[0];
  ...
  <tr>
    ...
    <td colspan="2" valign="top" class="fondo_6" ><div align="left">SELECCIONE UNA LISTA:
        <select name="lista_existentes" id="lista_existentes" class="select_ancho_automatico" onchange="ajax_carga('../aplicaciones/tarifas/proveedor/c_tarifas_masivas.php?id_contrato=<?=$id_contrato;?>&amp;lista_existentes=' + this.value,'carga_acciones_permitidas')">
...
<table width="100%" border="0" cellpadding="2" cellspacing="2">
  <tr>
    <td width="71%" valign="top"><br />
      ...
      <table width="98%" border="0" cellpadding="2" cellspacing="2" class="tabla_lista_resultados">
        <tr>
          <td colspan="4" class="fondo_2_sub"><strong >Crear tarifas masivas PASO 2</strong></td>
        </tr>
        <tr>
        ...
        <? 
		 $ya_tiene_cargue = traer_fila_row(query_db("select count(*) from t6_tarifas_lista where tarifas_contrato_id = ".$id_contrato_arr." and t6_tarifas_estados_tarifas_id = 10 and tipo_creacion_modifica in (3,5)"));
	   if($ya_tiene_cargue[0]==0){
        ...
        <? } else {  ?>
                <input type="hidden" name="aprobacion_secundaria_0" id="aprobacion_secundaria_0" value="0" />
                <? } ?>
        ...
        <tr>
          <td colspan="4" align="center" valign="top"><input type="button" name="button2" class="boton_grabar" id="button2" value="Presione este comando para cargar la plantilla" onclick="carga_tarifas_masivas('')" /></td>
        </tr>
        ...
        <tr>
          ...
          <td align="right" valign="top"><input type="button" name="button2" class="boton_buscar" id="button2" value="Ver el cargue previo" onclick="ajax_carga('../aplicaciones/tarifas/proveedor/v_tarifas_actualizar_masiva.php?id_contrato=<?=$id_contrato;?>&amp;lista_existentes=<?=$lista_existentes;?>&tipo_creacion=3','carga_acciones_permitidas')" /></td>
          <td align="center" valign="top"><input type="button" name="button4" class="boton_eliminar" id="button4" value="Descartar / Eliminar el Cargue previo" onclick="elminar_cargue_masivo_previo()" /></td>
          <td align="center" valign="top">&nbsp;</td>
        </tr>
        <tr>
          <td align="center" valign="top">&nbsp;</td>
      ...
      <table width="98%" border="0" cellpadding="2" cellspacing="2" class="tabla_lista_resultados">
        <tr>
          <td colspan="4" class="fondo_2_sub"><strong >Crear tarifas masivas PASO 3</strong></td>
        </tr>
        <tr>
          <td width="4%" valign="top">&nbsp;</td>
          <td width="42%">&nbsp;</td>
...
<input type="hidden" name="vigencia_contrato" value="<?=$sql_con[21];?>" />
        <input type="hidden" name="tipo_creacion" value="3" />
