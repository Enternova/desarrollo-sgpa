...
<table width="99%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="9%" class="titulos_secciones"><input type="button" name="button5" class="boton_volver" id="button5" value="Volver al menu" onclick="ajax_carga('../aplicaciones/tarifas/proveedor/c_tarifas_actualicar_masivas_ipc.php?id_contrato=<?=arreglo_pasa_variables($id_contrato);?>','carga_acciones_permitidas')" /></td>
  </tr>
</table>
...
$where_general = " tarifas_contrato_id = $id_contrato_arr  and t6_tarifas_estados_tarifas_id in (9) and t6_tarifas_listas_lista_id = $lista_existentes". $bus_tarifa_c;
...
$nobre_categori_impri="";
	...
	$busca_detalle = "select * from (
                      ...
                      us_aprobacion_actual, creada_luego_firme , ROW_NUMBER() OVER(ORDER BY categoria, grupo, tarifa_padre, fecha_creacion ) AS rownum from $v_t_3 where $where_general and tipo_creacion_modifica = 4
								) as sub
