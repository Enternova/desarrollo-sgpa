...
<table cellspacing="0" cellpadding="0" border="1">
  <tr>
    ...
    <td width="135" style="background-color:#C5D9F1; font-size:11px" valign="top" ><strong>
      <?=TITULO_18;?>
    :</strong> (No se pueden modificar los datos de esta columna)</td>
    <td width="124" style="background-color:#C5D9F1; font-size:11px" valign="top" ><strong><?=TITULO_5;?>:</strong> <?=TITULO_5b;?></td>
    <td width="124" style="background-color:#C5D9F1; font-size:11px" valign="top" ><strong><?=TITULO_4;?>:</strong> (Este campo es obligatorio).
      Medida utilizada para medir el servicio (ej.: km, gal&oacute;n, d&iacute;a, mes, etc.)    m&aacute;ximo 50 caracteres</td>
    <td width="191" style="background-color:#C5D9F1; font-size:11px" valign="top" > <strong><?=TITULO_7;?>:</strong> (Este campo es obligatorio).
    ...
    <td width="133" style="background-color:#C5D9F1; font-size:11px" valign="top" > <strong><?=TITULO_8;?></strong>: (Este campo es obligatorio).
    ...
    <td width="120" style="background-color:#C5D9F1; font-size:11px" valign="top" ><strong>Aplica    Descuento</strong>:o es    obligatorio).
      Digite &quot;SI&quot; o &quot;NO&quot; en mayúscula.</td>
  ...
  <tr>
    ...
    <td style="mso-number-format:'@';background-color:#8DB4E2; font-size:11px" valign="top">&nbsp;</td>
    <td style="mso-number-format:'@'; font-size:11px" valign="top"><?=$lista_tarifas[3];?></td>
    <td style="mso-number-format:'@'; font-size:11px" valign="top"><?=$lista_tarifas[5];?></td>
    <td style="mso-number-format:'@'; font-size:11px" valign="top"><?=$moneda_t;?></td>
