...
<table width="99%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td class="titulos_secciones_tarifas">SECCION:<span class="titulos_resaltado_procesos_tarifas"> ADMINISTRACION DE REEMBOLSABLE &gt;&gt; CONTRATO:
...
<table width="100%" border="0" cellpadding="2" cellspacing="2">
  <tr>
    ...
    <table width="99%" border="0" cellpadding="4" cellspacing="3" class="tabla_lista_resultados">
      <tr >
        <td colspan="3" class="fondo_4">Creaci&oacute;n de reembolsables</td>
      </tr>
      <tr>
        <td colspan="3" class="fondo_3"><div align="center">Detalle</div></td>
        </tr>
      <tr>
        <td width="21%"><div align="right"><strong>Porcentaje Adminsitrativo:</strong></div></td>
        <td width="21%"><select name="reembolsable_por" id="reembolsable_por">
        <option value="-1">Seleccione un porcentaje</option>
        ...
        <td width="58%"><input name="button2" type="button" class="boton_grabar" id="button2" value="Enviar nuevo reembolsable" onclick="crea_reembolsable()" /></td>
      </tr>
      <tr>
    ...
    <? } //si tiene descuentos ?>
      ...
      <table width="99%" border="0" cellpadding="2" cellspacing="2" class="tabla_lista_resultados">
        <tr >
          <td colspan="4" class="fondo_4">Historico de descuentos de este contrato</td>
        </tr>
        <tr>
          ...
          <td width="17%" class="fondo_3">Porcentaje reembolsable</td>
        </tr>
        
<?
	$busca_descuneto = query_db("select t6_tarifas_reembosables1_contrato_id, porcentaje_administracion, nombre_administrador, fecha_creacion, estado from $v_t_9 where t6_tarifas_contratos_id = $id_contrato_arr  order by fecha_creacion desc");
	while($traer_descvuentos = traer_fila_row($busca_descuneto)){
		...
		if($traer_descvuentos[1]=="-1")
			$valor_admin = "No Aplica";
		else
			$valor_admin = $traer_descvuentos[1];
...
?>
        ...
        <tr class="filas_resultados">
          ...
          <td class="titulos_resumen_alertas"><?=$valor_admin;?></td>
        </tr>
        <? } ?>
    </table></td>
  </tr>
