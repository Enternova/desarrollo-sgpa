...
<table width="99%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td width="91%" class="titulos_secciones_tarifas">SECCION:<span class="titulos_resaltado_procesos_tarifas"> ADMINISTRACION DE IPC &gt;&gt; CONTRATO:
...
<table width="100%" border="0" cellpadding="2" cellspacing="2">
  <tr>
    ...
    <table width="99%" border="0" cellpadding="4" cellspacing="3" class="tabla_lista_resultados">
      <tr >
        <td colspan="3" class="fondo_4">Creaci&oacute;n de IPC</td>
      </tr>
      <tr>
        <td colspan="3" class="fondo_3"><div align="center">Detalle</div></td>
        </tr>
      <tr>
        <td width="21%"><div align="right"><strong>Requiere IPC:</strong></div></td>
        <td width="21%"><select name="reembolsable_por" id="reembolsable_por">
        <option value="0">Seleccione</option>
		<option value="1">Si</option>   
		<option value="2">No</option>                
        </select></td>
        <td width="58%"><input name="button2" type="button" class="boton_grabar" id="button2" value="Configura IPC" onclick="crea_ipc_contrato()" /></td>
      </tr>
      <tr>
    ...
    <? } //si tiene descuentos ?>
      ...
      <table width="99%" border="0" cellpadding="2" cellspacing="2" class="tabla_lista_resultados">
        <tr >
          <td colspan="4" class="fondo_4">Historico de IPC configurados</td>
        </tr>
        <tr>
...
<?
	...
	$busca_descuneto = query_db("select t6_tarifas_ipc_contrato_id, ipc_administracion, nombre_administrador, fecha_creacion, estado from v_tarifas_ipc_contrato where t6_tarifas_contratos_id = $id_contrato_arr  order by fecha_creacion desc");
