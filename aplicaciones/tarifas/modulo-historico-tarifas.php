...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr class="titulos_secciones">
    <td class="titulos_secciones">SECCION: HISTORICO DE TARIFAS</td>
  </tr>
</table>
    ...
    <td colspan="3" valign="top">
      <table width="100%" border="0" cellpadding="2" cellspacing="2" class="tabla_lista_resultados">
        ...
        <tr>
          ...
          <td onclick="ajax_carga('c_tarifas.php','carga_acciones_permitidas')"><div align="right"><strong>Por estatus de aprobación</strong></div></td>
...
<table width="100%" border="0" cellpadding="2" cellspacing="2" class="tabla_lista_resultados">
  ...
  <tr>
    <td width="5%" class="columna_subtitulo_resultados"><div align="center">Contrato</div></td>
    <td width="39%" class="columna_subtitulo_resultados"><div align="center">Detalle</div></td>
    ...
    <td width="7%" class="columna_subtitulo_resultados">Moneda</td>
    <td width="9%" class="columna_subtitulo_resultados"><div align="center">Valor</div></td>
    <td width="5%" class="columna_subtitulo_resultados">Nueva</td>
    <td width="8%" class="columna_subtitulo_resultados">Modificada</td>
    <td width="8%" class="columna_subtitulo_resultados">Aprobación</td>
    <td width="6%" class="columna_subtitulo_resultados">Historia</td>
  </tr>
  <tr class="filas_resultados">
    ...
    <td class="titulos_resumen_alertas"><div align="center"><img src="../../imagenes/botones/variacion_tarifas.png" alt="Esta tarifa ha tenido actualización" title="Esta tarifa ha tenido actualización" width="24" height="24" /></div></td>
  </tr>
  <tr>
    ...
    <td class="titulos_resumen_alertas"><div align="center"></div></td>
  </tr>
  <tr class="filas_resultados">
