<? include("../../../librerias/lib/@session.php"); 
	...
	$busca_grupo = "select id,nombre,estado from $evf5 where id = 3";
	$sql_grupo=traer_fila_row(query_db($busca_grupo));
	
	$busca_plantilla = "select id,nombre,estado from $evf3 where id = 1";
	$sql_plantilla=traer_fila_row(query_db($busca_plantilla));
...
<body>
  <?
			imprime_cabeza_proveedor($id_contrato);
			?>
...
?>
<tr>
  <td width="100%" align="center" id="fila_crea_evaluacion1">
 	 <table width="100%" border="0" cellpadding="2" cellspacing="2" class="tabla_lista_resultados">
  <tr>
...
<tr>
  ...
  <br />
	...
	<tr class="fondo_3">
    	<td colspan="2" align="left" valign="top"><img src="../imagenes/botones/help.gif" alt="xx" width="20" height="20" /><?=$sql_grupo[1];?> - <?=$sql_plantilla[1];?></td>
    ...
    <?
	$lista_poliza_int = "select id,id_plantilla,nombre,estado from ".$evf4."  where estado = 1 and id_plantilla = 1 order by id";
...
<tr>
  <td align="center" id="fila_crea_evaluacion2">&nbsp;</td>
</tr>
