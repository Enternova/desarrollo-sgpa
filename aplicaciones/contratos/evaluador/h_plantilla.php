...
<table width="100%" border="0" cellpadding="2" cellspacing="2" class="tabla_lista_resultados">
	...
	<tr>
		<td width="20%" align="right" >Plantilla HSE:</td>
	...
	<tr>
      ...
      if($id_pregunta_arr!=""){
		?>
      	<input name="button2" type="button" class="boton_grabar" id="button2" value="Editar Plantilla" onclick="graba_pregunta(<?=$id_pregunta_arr;?>)"/>&nbsp;&nbsp;
      <?  
	  }else{
	  ?>
      <input name="button2" type="button" class="boton_grabar" id="button2" value="Crear Plantilla" onclick="graba_pregunta(99)"/>&nbsp;&nbsp;
      <?
	  }
	  ?>
      </td>
	...
	<tr class="fondo_4">
	  <td colspan="3" >Listado de Plantillas HSE</td>
  </tr>
  <tr class="columna_subtitulo_resultados">
	  <td colspan="2" >Plantillas</td>
      <td  >Editar</td>
  </tr>
  <?
