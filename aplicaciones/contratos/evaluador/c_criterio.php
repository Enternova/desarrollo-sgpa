...
<table width="100%" border="0" cellpadding="2" cellspacing="2" class="tabla_lista_resultados">
  ...
  <?
	$lista_poliza_int = "select id,id_grupo,nombre,estado from ".$evf1."  where estado = 1 and id_grupo = ".elimina_comillas(arreglo_recibe_variables($id_grupo))." order by id";
