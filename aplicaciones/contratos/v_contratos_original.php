...
/*	if($_SESSION["id_us_session"] == 32){
      ...
      <tr>
        ...
        <td colspan="2" align="right"><?=$alerta1;?>
          Monto:</td>
        <td colspan="2" class="titulos_resumen_alertas" align="left">
        <?
        if($sql_con[34]==2){?>
        ...
        <table width="99%" border="0" cellpadding="2" cellspacing="2" >
          ...
          <tr>
            <td width="20%" align="center" class="titulos_resumen_alertas">COP</td>
            <td width="80%" class="titulos_resumen_alertas"><input name="monto_cop" type="hidden" id="monto_cop" size="15" maxlength="15" value="<?=valida_numero_imp($sql_con[18]);?>"  onkeypress="if (event.keyCode &lt; 48 || event.keyCode &gt; 57) event.returnValue = false;" onkeyup="puntos(this,this.value.charAt(this.value.length-1))"/>
	...
	?>
      ...
      <tr>
        ...
        <td colspan="2" align="right">&nbsp;</td>
        <td width="6%" align="center" class="titulos_resumen_alertas">&nbsp;</td>
        <td width="26%" class="titulos_resumen_alertas">&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td width="31%">&nbsp;</td>
        <td colspan="2" align="right">&nbsp;</td>
        <td colspan="2" class="titulos_resumen_alertas">
		
		<? if($_SESSION["id_us_session"]==1 or $_SESSION["id_us_session"]==32){ /*?>
        
        
        <a href="../librerias/php/tarifas_procesos_admin.php?contrato_a=<?=$id_contrato_arr?>&tipo_creaci=1&consecu=<?=imprime_cabeza_contrato_limpio($id);?>" target="grp">Crear tarifas <?=imprime_cabeza_contrato_limpio($id);?></a>
