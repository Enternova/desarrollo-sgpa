...
<tr>
	<td id="fila_evaluador1">
		<table width="100%" border="0" cellpadding="2" cellspacing="2">
			<tr >
				<td valign="top"><span onclick="javascript:document.getElementById('fila_evaluador1').style.display = 'none';ajax_carga('../aplicaciones/contratos/c_plantilla.php?id_contrato=<?=$id_contrato;?>','fila_evaluador2')" style="cursor:pointer">Crear Nueva Plantilla</span></td>
                <?
                if($sql_tipo[0] == 2 ){
				?>
				<td valign="top">&nbsp;</td>
