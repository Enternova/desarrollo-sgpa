...
$semaforo=0;
                    ...
                    while ($sel_sin_comi = traer_fila_db($sel_item_sin_comite)) {
                        ...
                        $sel_item = traer_fila_row(query_db("select "
								...
								. "convirte_marco from $pi2 where id_item=" . $sel_sin_comi[0]));
                        ...
                        } elseif ($sel_item[3] == 5 or $sel_item[3] == 7) {
					$sel_presupuesto = traer_fila_row(query_db("select sum(valor_usd), sum(valor_cop) from $pi8 where t2_item_pecc_id = " . $sel_item[0] . " and permiso_o_adjudica = 1"));
...
//"select id_item,1, 2, t1_tipo_proceso_id,CAST(alcance AS TEXT),5,6, 7,CAST(ob_contrato_adjudica AS TEXT),alcance_adjudica,CAST(justificacion_adjudica AS TEXT),CAST(recomendacion_adjudica AS TEXT),CAST(objeto_contrato AS TEXT), t1_area_id, t1_trm_id,contrato_id, proveedores_sugeridos, id_item_peec_aplica,id_solicitud_relacionada,19,20,CAST( criterios_evaluacion AS TEXT) from $pi2 where id_item=".$sel_sin_comi[0]
						...
						if($sel_sin_comi[26]==0 or $sel_sin_comi[23]==""){//si no tiene el valor solicitado ingresarlo
							$update = query_db("update t3_comite_relacion_item set valor_solicitado_cop = '".$sel_presupuesto[1]."', valor_solicitado_usd = '".$sel_presupuesto[0]."', valor_solicitado_eq='".$val_usd."' where id_relacion = ".$sel_sin_comi[9]);
							}
                            ...
                            <td colspan="2" align="center"><table width="99%" border="0" cellpadding="2" cellspacing="2" class="tabla_lista_aproba_comite">
                                    <tr >
                                        <td colspan="6" align="center" class="fondo_3"><strong>Datos de la Solicitud <font size="+2">
                                                ...
                                                <? if($_GET["id_item_consulta_firma"] ==0){ ?>
                                                <strong class="titulo_calendario_real_bien" onClick="abrir_ventana('../aplicaciones/comite/pecc/edicion-item-pecc.php?id_item_pecc=<?= $sel_item[0] ?>&id_tipo_proceso_pecc=<?=$id_tipo_proceso_pecc?>&conse_div=<?= $conse_div ?>&permiso_o_adjudica=<?=$permiso_o_adjudica ?>')" > <img src="../imagenes/botones/detalle.png" height="30" /></strong>
                                                <? }?>
                                                </td>
                                    </tr>
                                    ...
                                    <tr >
                                        ...
                                        <td colspan="5" align="left"><? echo $objeto_solicitud;  ?></td>
                                    </tr>
                                    <tr class="columna_subtitulo_resultados_letra_normal" >
                                        ...
                                        <td colspan="5" align="left"><? echo $alcance ?></td>
                                    </tr>
					...
					if($antecedentes!=""){
								  ?>  
                                    <tr >
                                      ...
                                      <td colspan="5" align="left"><?=$antecedentes?></td>
                                    </tr>
                               <?
					}// fin antecedentes
					?>     
                                    ...
                                    <tr >
                                        ...
                                        <td width="141" align="left"><?= number_format($sel_valores[0], 0) ?> </td>
                                        <td width="206" align="left" class="">&nbsp;</td>
                                        <td width="231" colspan="2" align="right" valign="top">&nbsp;</td>
                                    </tr>
                                    <tr  >
                                        <td align="right">&nbsp;</td>
                                        <?php
                                    ...
                                    <tr  >
                                      ...
                                      <td align="left" class="columna_subtitulo_resultados_letra_normal"><?= number_format($sel_presupuesto[0], 0) ?></td>
                                      <td rowspan="2" align="left" >&nbsp;</td>
                                      <td rowspan="2" align="left" valign="bottom"><?php
                                            if ($tiene_permiso_secretrio == "SI" and $sel_item[3] <> 8 ) {
                                                if (($sel_item[2] == 7 and $sel_item[3] ==1 or $sel_item[3] ==2) or ( $sel_item[3] ==5 or $sel_item[3] ==7 or $sel_item[3] ==9 or $sel_item[3] ==10 or $sel_item[3] ==11 or $sel_item[3] ==12 or $sel_item[3] ==16)) {//si va para asignacion presupuestal
                                                    // Guardar según Invitacion a proponer, negociacion directa, proveedor exclusivo.
                                                    ?>
                                        <input type="button" value="Editar Valores de esta solicitud" class="boton_grabar" onClick='window.parent.document.getElementById("carga_edicion_valores_<?=$sel_item[0] ?>").style.display=""; ajax_carga("../aplicaciones/pecc/asignacion-presupuestal.php?id_item_pecc=<?= $sel_item[0] ?>&id_comite=<?=$id_comite ?>&desde_comite=SI", "carga_edicion_valores_<?=$sel_item[0] ?>");'/>
                                        <?php
                                                       }
												if (($sel_item[2] == 16 and $sel_item[3] ==1 or $sel_item[3] ==2 or $sel_item[3] ==6) ) {//si va para adjudicacion.
				...
				$link_adjudicacion = "adjudicacion-marco";
					...
					if($sele_tipo_doc_desierto[13]==4){
						...
						$link_adjudicacion = "adjudicacion";
                                    ...
                                    <tr  >
                                      <td colspan="6" align="right"><div id="carga_edicion_valores_<?=$sel_item[0] ?>" style="display:none"></div></td>
                                    </tr>
                                    <tr  >
                                    ...
                                    <tr >
                                        ...
                                        <td colspan="5" align="left"><? echo $justificacion_comercial ?></td>
                                    </tr>
                                    <?
					}
									?>
...
"  width="20" height="20" /></strong></td>
                                        <td colspan="5" align="left"><? echo $justificacion_tecinica ?></td>
                                    </tr>
                                    ...
                                    <tr >
                                        ...
                                        <td colspan="5" align="left"><?= $sel_item[21] ?></td>
                                    </tr>
                                    <tr class="columna_subtitulo_resultados_letra_normal" >
                                        <td align="right"><strong>Recomendaci&oacute;n <img src="../imagenes/botones/help.gif" alt="Acci&oacute;n, valor, contratista/proveedor y vigencia
                                                                                            ...
                                                                                            "  width="20" height="20" /></strong></td>
                                        <td colspan="5" align="left"><?  echo $recomendacion?></td>
                                    </tr>
                                    <tr >
							  ...
							  if($sel_sin_comi[2] == 2 or $sel_sin_comi[23] == ""){//si el estado de la solciitud es pendiente (2) muestre el resultado de la funcion
                                                echo $imprimir_de_funcion = contratos_relacionados_comite_solo_contratos($sel_item[18], $permiso_o_adjudica);
	...
	$uodate_terminacion = query_db("update t3_comite_relacion_item set campo_contrato_vencimiento = '".$imprimir_de_funcion."' where id_relacion = ".$sel_sin_comi[9]);									
			...
			$p_sostenibilidad=$busvca_tex[6];
                                      ...
                                      <table width="80%" border="0" align="center" cellpadding="2" cellspacing="2" bgcolor="#FFFFFF"   class="tabla_lista_resultados">
                                        <tr class="fondo_3">
                                          <td align="center" >Objetivos del Proceso</td>
...
<div id="no_verificado_<?=$sel_sin_comi[0]?>">
                                    ...
                                    <?php } else{
										?>
										 <tr>
                                            <td width="413" align="right"><strong>Verificacion del Presidente <img src="../imagenes/botones/help.gif" alt="El presidente debe verificar este proceso para ser finalizado" title="El presidente debe verificar este proceso para ser finalizado" width="20" height="20" /></strong></td>
                                            <td colspan="5" align="left">No Requiere</td>
                                        </tr>
										<?php
