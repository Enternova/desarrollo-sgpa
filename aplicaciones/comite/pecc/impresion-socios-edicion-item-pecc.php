...
$sel_item_obs = traer_fila_db(query_db("select CAST(objeto_solicitud AS text), CAST(objeto_contrato AS text), CAST(alcance AS text), CAST(justificacion AS text), CAST(recomendacion AS text) from $pi2 where id_item=".$id_item_pecc));
	...
	if($permiso_o_adjudica == 1  or $sel_item[6] == 7 or $sel_item[6] == 8 or $sel_item[6] == 9 or $sel_item[6] == 10 or $sel_item[6] == 11 or $sel_item[6] == 4 or  $sel_item[6] == 5){
		...
		$sel_item_obs_ad = traer_fila_db(query_db("select CAST(ob_solicitud_adjudica AS text), CAST(ob_contrato_adjudica AS text), CAST(alcance_adjudica AS text), CAST(justificacion_adjudica AS text), CAST(recomendacion_adjudica AS text) from $pi2 where id_item=".$id_item_pecc));
	...
	$valor_solicitud = traer_fila_row(query_db("select sum(valor_usd), sum(valor_cop), (sum(valor_cop) / trm)+sum(valor_usd) from $vpeec22 where id_item = ".$id_item_pecc." and permiso_o_adjudica = ".$permiso_o_adjudica." group by trm"));
	?>
...
<table width="90%" border="0" align="center" class="tabla_principal">
  <tr>
    <td colspan="3"><img src="https://www.abastecimiento.hocol.com.co/sgpa/imagenes/coorporativo/logo-cliente-blanco.jpg" alt="" width="130" height="68"></td>
  </tr>
  <tr>
  ...
  <tr>
	...
	?>
      <tr>
        ...
        <td width="29%" align="left"><?=$sel_contra_otro_si[5]?></td>
        <td width="19%" align="right">Proveedor:</td>
      ...
      <tr>
        ...
        <tr>
        <td align="right"  width="26%" ><strong>Tipo de Negociaci&oacute;n:</strong></td>
  ...
  <tr>
    <td colspan="3"><table width="98%" border="0" align="center"  class="tabla_sub2">
      ...
      <tr>
        ...
        <td width="22%" align="right"><strong>Gerente del Contrato:</strong></td>
  ...
  <tr>
    <td colspan="2" class="titulo2"><strong>Justificaci&oacute;n:</strong></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td colspan="3"><table width="98%" border="0" align="center"  class="tabla_sub3">
      <tr>
        <td colspan="4" align="left"><?=$ob_justificacion?></td>
      </tr>
    </table></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="3"><table width="98%" border="0" align="center"  class="tabla_sub4">
      <tr>
        <td colspan="4" align="left"><?=$ob_recomendacion?></td>
      </tr>
    </table></td>
  </tr>
  <?
	...
	?>
  <tr>
    <td colspan="2"  class="titulo2"><strong>Detalle del Monto Solicitado:</strong></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td colspan="3">
...
$cont = 0;
  $clase="";
  $sele_anexos = query_db("select * from $pi9 where t2_item_pecc_id = '".$id_item_pecc."' and estado = 1 and tipo not in ('') order by t2_anexo_id");
  ...
  ?>
      <tr class="<?=$clase?>">
		...
		if($sl_anexos[3] == "anexo") echo "Anexos de Permiso";
...
?>
  ...
  <tr>
    <td colspan="3"><table width="98%" border="0" align="center"  class="tabla_sub7">
      <tr>
        ...
        <td colspan="3" rowspan="2" align="left" class="tabla_sub7_1"><?=$ob_alcance?></td>
        </tr>
      <tr>
        <td align="right">&nbsp;</td>
        </tr>
  ...
  <? if($sel_item[6] <> 7 and $sel_item[6] <> 8){//SI NO ES AMPLIACION IMPRIMA PROVEEDORES?>
  <tr>
  ...
  <tr>
    ...
    <table width="98%" border="0" align="center"  class="tabla_proveedores">
      <tr>
        <td colspan="4">Lista de Proveedores Propuestos por el Profesional de C&amp;C</td>
        </tr>
      <tr>
        ...
        <td width="15%" align="center"  class="fondo_3"> Calificaci&oacute;n</td>
        </tr>
      <?
  ...
  <?
  }//FIN SI NO ES AMPLIACION IMPRIMA PROVEEDORES
  ...
  <tr>
	...
	<?
    if($permiso_o_adjudica == 1){ echo "el Permiso";}
