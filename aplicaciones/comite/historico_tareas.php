...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <table width="100%" border="0" cellpadding="2" cellspacing="2" class="tabla_lista_resultados">
    ...
    <tr>
      ...
      <td width="3%" align="center" class="columna_subtitulo_resultados">Numero</td>
      <td width="5%" align="center" class="columna_subtitulo_resultados">Fecha de Creacion</td>
      <td width="6%" align="center" class="columna_subtitulo_resultados">Fecha del Requerimiento</td>
...
if($sel_para_insert[8] == 15){ 
    ...
    <tr class="<?=$clase?>">
      ...
      <td align="center"><?=$sel_para_insert[21]?></td>
      <td align="center"><?=$fecha_requiere?></td>
      <td><? if($sel_para_insert[22]==1){echo "Modificacion";}else {echo $nom_tipo_proceso;}?></td>
