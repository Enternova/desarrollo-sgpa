...
<?php
  ...
  <tr>
    <td colspan="3" align="center"><input type="button" name="button" id="button" value="Buscar" class="boton_grabar" onclick="ajax_carga('../aplicaciones/comite/historico-tareas-comite.php?busca_id_responsable='+document.principal.busca_id_responsable,'contenidos');" /></td>
  </tr>
  <td colspan="5" align="right"><a href=""><strong><font size="+1">Generar Reporte  en EXCEL</font></strong> <img src="../imagenes/mime/xlsx.gif"></a>
  ...
  <?php
  $cont = 0;
  $sel_proce="select id_tarea, responsable, cierre, cast(titulo as text) as titulo, num1, num2, num3, fecha_cierre, nums1, nums2, muns3, id_responsable, id_cierre, estado, numt1, numt2, numt3 from $vcomite3";
  echo $sql_comple;
