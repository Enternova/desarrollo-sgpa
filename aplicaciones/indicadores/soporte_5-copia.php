...
header("content-disposition: attachment;filename=Soporte 5.xls");
...
<table width="100%" border="1">
  <tr>
    <td colspan="15" align="center" bgcolor="#E4E4E4">&nbsp;</td>
    <td colspan="6" align="center" bgcolor="#3399FF"><pre>Gestiones</pre></td>
  </tr>
  <tr>
  ...
  <?
  	...
  	$sel_1 = query_db("select * from version_2_indi_soporte_3 ".$_SESSION["comple_filtro4"]." and dias_realas <> '100000' order by id_item, t2_nivel_servicio_actividad_id asc");
