...
header("content-disposition: attachment;filename=Soporte Nivel de aprobacion.xls");
...
<table width="100%" border="1">
  ...
  <?
  	...
  	$sel_1 = query_db("select * from " . $_SESSION["version_2_indi_soporte_1"] . " ".$_SESSION["comple_filtro2"]);
