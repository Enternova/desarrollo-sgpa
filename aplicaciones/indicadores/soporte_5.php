...
header("content-disposition: attachment;filename=Soporte Detallado de Solicitudes (Todo).xls");
...
<table width="100%" border="1">
  ...
  <?
	...
	$actividados_no_muesstra = " and t2_nivel_servicio_actividad_id not in (12.1, 19) and t2_nivel_servicio_actividad_id <= 20";
	/** PARA EL DES002-18 **/
	...
	/** PARA EL DES002-18 **/
  	$sel_1 = query_db("select * from " . $vpeec_aplica . " ".$_SESSION["comple_filtro4"]." $actividados_no_muesstra   order by id_item, t2_nivel_servicio_actividad_id asc");
