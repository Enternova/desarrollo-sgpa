...
header("content-disposition: attachment;filename=Soporte numero de procesos.xls");
...
<table width="100%" border="1">
  <tr>
    ...
    <td width="21%" align="center" bgcolor="#E4E4E4"><pre>PECC</pre></td>
    ...
    <td width="12%" align="center" bgcolor="#E4E4E4"><pre>Rechazado</pre></td>
    <td width="12%" align="center" bgcolor="#E4E4E4"><pre>Declado Desierto</pre></td>
  </tr>
  <?
  

  	$sel_1 = query_db("select * from " . $_SESSION["version_2_indi_soporte_1"] . " ".$_SESSION["comple_filtro"]);
  ...
  <tr>
    ...
    <td><? if($s_1[26] == 1 or  $s_1[26] == 0 or $s_1[26] == "") echo "Ninguno"; else echo $s_1[26];?></td>
    <td><?=$s_1[3]?></td>
    <td><?=$s_1[5]?> <? if($s_1[24]==1) echo " - Modificaci&oacute;n";?></td>
    <td><?=$s_1[6]?></td>
