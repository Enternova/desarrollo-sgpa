...
header("content-disposition: attachment;filename=Soporte Consolidado de Solicitudes (Todo).xls");
...
<table width="100%" border="1">
  ...
  $campos_vista_soporte = "num1, num2, num3, profesional, fecha_creacion, tipo_proceso, area, congelado, estado_nombre, id_us_profesional_asignado, t1_tipo_proceso_id, t1_area_id, tiempos_estandar, de_historico, estado, nivel_aprobacion_nom, nivel_aprobacion, fecha_reprograma_fin, fecha_finalizacion, estado_atrazado_atiempo, id_item, t2_nivel_servicio_id, solicitud_rechazada, solicitud_desierta, CAST(objeto_solicitud AS TEXT), CAST(ob_solicitud_adjudica AS TEXT), t1_tipo_contratacion_id,es_modificacion, fecha_en_firme";
  	...
  	$sel_1 = query_db("select * from " . $_SESSION["version_2_indi_soporte_2"] . " ".$_SESSION["comple_filtro4"]);
