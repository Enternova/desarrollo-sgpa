...
<table width="99%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td class="titulos_secciones">SECCION: HISTORICO DE TIPOS DE PROCESO</td>
  </tr>
</table>
<table width="99%" border="0" cellpadding="2" cellspacing="2" class="tabla_lista_resultados">
	<tr align="center">
    	<td class="titulo_tabla_azul_sin_bordes">&nbsp;</td>
  	</tr>
</table>
<br />
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td class="titulos_secciones">Lista de Tipos de proceso</td>
  </tr>
</table>
...
/*if($complemento=="")
  ...
  */
  $cont=0;
  $busca_procesos = "select *  from t1_tipo_proceso ";
  ...
  <tr class="<?=$clase;?>">
    ...
    <td><div align="center"><img src="../imagenes/botones/editar_c.png" width="16" height="16" onclick="ajax_carga('../aplicaciones/administracion/modifica_tp_proceso.php?pv_id=<?=$ls[0];?>','contenido_aux_sub');ingresar_listado('contenido_aux')" /></div></td>
  </tr>
  <tr class="<?=$class;?>">
    <td colspan="2"></td>
