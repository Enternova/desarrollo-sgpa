<?
	...
	include('../../librerias/php/funciones_html.php');
		...
		if($consulta4[0]==3){
			...
			$select_tabla="select id_aspectos_nuevo, nombre_aspectos, puntaje_maximo, puntaje_obtenido,fecha_inicio_contrato FROM vista_t9_contrato_marco where estado_aspecto='1' and id_evaluacion=".$id_evaluacion." group by id_aspectos_nuevo, nombre_aspectos, puntaje_maximo, puntaje_obtenido,fecha_inicio_contrato";
