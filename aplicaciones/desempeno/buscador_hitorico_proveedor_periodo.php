...
$comple_sql=" WHERE id_estado_criterio not in(0)";
...
$comple_sql.=" AND id_proveedor=".$_SESSION["sql_comple_periodo"];
...
$funcion1='muestra_detalle_resultado|&#xE154;| |color: #229BFF; cursor: pointer !important; background: trasparent;| |Gestionar';

$campos=carga_tabla_hmtl_solo_body($funcion1, '', '', $sql_rows, 4, 'body_periodo_proveedor_documento');
$footer=carga_paginador_hmtl_solo_body($regis_inicial, $regis_final, $total_registros[0], $posicion_pagina, $pagina, 5, 'foot_periodo_proveedor_documento', $registros_por_pagina[0], 'paginador_resultados_periodo_documento');
