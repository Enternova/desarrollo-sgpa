...
<?		
		...
		if($consulta4[0]==1){
			 ...
			 $result=traer_fila_row(query_db("select objeto, nombre_proveedor, periodo_evaluacion, nombre_gerente, numero_documento,id_documento,id_estado_criterio, id_crea_aspectos FROM vista_t9_servicio_menor where estado_aspecto=1 and id_evaluacion=".$id_evaluacion));
		...
		if($consulta4[0]==2){
			...
			$result=traer_fila_row(query_db("select fecha_inicio_contrato,fecha_fin_contrato,objeto,nombre_proveedor,periodo_evaluacion,nombre_gerente,numero_documento,id_documento,id_estado_criterio from vista_t9_contrato_puntual where estado_aspecto=1 and id_evaluacion=".$id_evaluacion));
		...
		if($consulta4[0]==3){
			...
			$result=traer_fila_row(query_db("select fecha_inicio_contrato,fecha_fin_contrato,objeto,nombre_proveedor,periodo_evaluacion,nombre_gerente,numero_documento,id_documento,id_estado_criterio from vista_t9_contrato_marco where estado_aspecto=1 and id_evaluacion=".$id_evaluacion));
		...
		menu_banner('s12 m12 l12', '<div class="row">
		<div class="col s12 m6 l8">
		Numero del Documento Contractual: &nbsp;&nbsp;' .$numero_contrato.'
		<br>Fecha del Documento: &nbsp;&nbsp;' .$fecha_inicial_documento. '/' .$fecha_final_documento.'
		<br>Objeto: &nbsp;&nbsp;' .$objeto_documento.'</div>
		<div class="col s12 m6 l4">
		Nombre Contratista: <br>' .$nombre_contratista.'
		<br>Periodo A Evaluar: <br>' .$periodo.'
		<br>Gerente / Solicitante: <br>' .$gerente_solicitante.'
		</div></div>
		', 'font-size: 16pt; font-weight: 900 !important; tex-align:center; tex-align:justify; color: #ffffff;','color: #229BFF; tex-align:center;','background:#229BFF !important;');
...
<div class="row">
	...
	<?  
		...
		menu_lista('s12 m2 l3', '&#xE254;', '<center>administracion <br> de criterios</center>', 'da click para ir administrar', '&#xE86C;', 
		...
		menu_lista('s12 m2 l3', '&#xE8CE;', '<center>aprobaci&oacuten <br> de criterios</center>', 'estado de la aprobaci&oacuten', '&#xE86C;', 
		...
		menu_lista('s12 m2 l3', '&#xE862;', '<center>aprobaci&oacuten <br> de evaluaci&oacuten</center>', 'estado de la aprobaci&oacuten', '&#xE86C;', 
