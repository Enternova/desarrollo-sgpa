<?
	...
	$id_evaluacion=elimina_comillas(arreglo_recibe_variables($_GET['id_evaluacion']));
		...
		if($consulta4[0]==3){
			...
			$select_tabla="select  nombre_aspectos, puntaje_maximo, fecha_inicio_contrato FROM vista_t9_contrato_marco where estado_aspecto='1' and id_evaluacion='".$id_evaluacion."' group by nombre_aspectos, puntaje_maximo, fecha_inicio_contrato";
