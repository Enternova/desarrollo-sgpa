<?
	...
	echo $id_proveedor=$id_proveedor." AND fecha_periodo_evaluado BETWEEN '".$periodo[0]."' AND '".$periodo[1]."'";
	echo "<br>ano anterior: ".$periodo[0]." ano actual: ".$periodo[1]." id:".$id_proveedor;
?>
		<div class="titulos_secciones" ><h5 id="titlulo_resultado" style="font-size:18pt !important; font-weight: 900 !important;">RESULTADOS DEL PERIODO <?=$periodo2;?> DEL PROVEEDOR <?=$nombre_proveedor[0];?></h5></div>
