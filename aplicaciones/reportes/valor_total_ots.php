      ...
      <tr class="fondo_3">
       ...
       /* 
          ...
          */
          ...
          // $cuenta_para_rowspan = traer_fila_row(query_db("select count(*) from t2_reporte_marco_temporal where id_us= '".$_SESSION["id_us_session"]."'  and tipo = 'ots'  and contratos = '".$sel_ots_cuadr[0]."' ".$comple_sql));
       ...
       $trm=trm_presupuestal($s_valores[5]);       
        ...
        $valor_eqi_t_ot=$valor_equivalente+$valor_eqi_t_ot;
          */
          ...
          <td align="center"  class="<?=$classe?>"><?=number_format($s_valores[7],0)?></td>
          <td align="center"  class="<?=$classe?>"><?=number_format($s_valores[8],0)?></td>
          <td align="center"  class="<?=$classe?>"><?=number_format($valor_equivalente,2)?></td>
          <td align="center"  class="<?=$classe?>"><?=number_format($trm,0)?></td>
...
<? 
      ...
      <td align="center" >&nbsp;</td>
      <td align="center">&nbsp;</td>
      <td align="center" class="fondo_3" ><?=number_format($valor_usd,0)?></td>
      <td align="center" class="fondo_3" ><?=number_format($valor_cop,0)?></td>
      <td align="center" class="fondo_3" ><?=number_format($valor_equivalente_ots,2)?></td>
      <td align="center" ></td>
    </tr>
...
?>
    ...
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td align="center" class="fondo_3"><?=number_format($valor_usd)?></td>
      <td align="center" class="fondo_3"><?=number_format($valor_cop)?></td>
      <td align="center" class="fondo_3"><?=number_format($valor_equivalente_ots)?></td>
      <td>&nbsp;</td>
    </tr>
  </table></td>
</tr>
<tr>
  <td colspan="2" align="right"><strong style="cursor:pointer" onclick="abrir_ventana('../aplicaciones/reportes/valor_total_ots_excel.php?id_solicitud=<?=$_GET["id_solicitud"]?>&eq_moneda=<?=$eq_moneda?>&id_contrato=<?=$_GET["id_contrato"]?>')" >Exportar reporte a Excel <img src="../imagenes/mime/xlsx.gif"  /></strong></td>
  </tr>
<tr>
