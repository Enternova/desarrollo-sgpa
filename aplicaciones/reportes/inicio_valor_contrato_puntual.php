...
<body>
  ...
  <div class="titulos_secciones">SECCION: Reportes - Valor Contrato Puntual</div>
  <br />
  ...
  <tr>
    ...
    <td width="9%"><select name="n_contrato_ano" id="n_contrato_ano">
  ...
  <tr>
    <td width="28%" align="right">N&uacute;mero de la Solicitud:</td> 
          <td width="6%">
