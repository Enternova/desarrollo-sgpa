...
<table width="100%" border="1">
  <tr>
    ...
    <td colspan="28" align="left" class="titulo1"><strong>CONSOLIDADO ACTAS DE COMITÉ</strong></td>
  </tr>
  <tr class="titulo2">
    <td align="right">&nbsp;</td>
  ...
  ?>
  <tr>
    <td align="center" rowspan="2" class="titulo3" >N&uacute;mero del Comité</td>
    <td align="center" rowspan="2" class="titulo3">Fecha del Comité</td>
    ...
    <td align="center" rowspan="2" class="titulo3">Resultado del Comité</td>
   <? if($bloquea_ratificacion == ""){?> <td align="center" rowspan="2" class="titulo3">Verificaci&oacute;n del Presidente</td><? }?>
    ...
    <td align="center" rowspan="2" class="titulo3">Comentario del Comité</td>
	...
	?>
    <td align="center" rowspan="2" class="titulo4">Fecha Ideal de Presentación a Comité (<strong class="titulo4_sub1">Esta información es calculada con respecto a los tiempos promedio por proceso</strong>)</td>
    <td align="center" rowspan="2" class="titulo4">Fecha de Vencimiento del Contrato  (<strong class="titulo4_sub1">Esta información es tomada del módulo de contratos, congelada en la fecha de presentación al comité</strong>)</td>
    <td align="center" rowspan="2" class="titulo4">Fecha real de Presentaci&oacute;n a Comité (<strong class="titulo4_sub1">Esta información es tomada de la fecha de celebración del comité</strong>)</td>
    <td align="center" rowspan="2" class="titulo4">A Tiempo / Fuera de Tiempo Vigencia (<strong class="titulo4_sub1"> 1. ADJUDICACIONES / PERMISOS: Que la "Fecha Ideal de Presentación a Comité" sea igual o anterior a la "Fecha Real de Presentación al Comité"  2. OTROSI: Valida que la "Fecha de Vencimiento del Contrato" mas 36 días hábiles no sea superior a la fecha real de presentación a Comité</strong>) </td>
    <td align="center" rowspan="2" class="titulo4">Porcentaje de Ejecuci&oacute;n (<strong class="titulo4_sub1">Esta información se toma del ultimo reporte de contratos a la fecha de presentación al comité</strong>)</td>
    <td align="center" rowspan="2" class="titulo4">A tiempo / Fuera de Tiempo Ejecuci&oacute;n (<strong class="titulo4_sub1">Esta información se calcula con base en el porcentaje de ejecución: Menor o igual a <?=$indicador_porcentaje?>% A Tiempo, mayor a <?=$indicador_porcentaje?>% Fuera de Tiempo</strong>)</td>
    <td align="center" rowspan="2" class="titulo4">Observación</td>
    <?
	  }
	?>
  </tr>
...
//   echo $sel_r[23].": ";
   if($sel_r[23]==4 or $sel_r[23]==5 or $sel_r[23]==7 ){//solo si es otro si
	   ...
	   for($i=0; $i < $cuantos_contratos; $i++){
		   ...
		   if($cont > 1){
		   $observacion = "Este indicador toma la información del contrato mas cercana a estar fuera de tiempo en vigencia y/o ejecución";
		   }
	   }
