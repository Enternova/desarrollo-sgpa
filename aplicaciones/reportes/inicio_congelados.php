...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr class="titulos_secciones">
    <td class="titulos_secciones">SECCION: Reportes - Congelados</td>
  </tr>
</table>
<br />
  ...
  <!--<tr>
    <td valign="top" id="carga_acciones_permitidas2"><table width="100%" border="0" cellpadding="2" cellspacing="2" class="tabla_lista_resultados">
      ...
      <tr>
        ...
        <td >&nbsp;</td>
        <td width="14%" >&nbsp;</td>
        <td width="38%" align="right" ><A href="javascript:document.location.target='_blank';document.location.href='../aplicaciones/contratos/reportes/historico_congelado_general.php'">Generar Reporte en EXCEL <img src="../imagenes/mime/xlsx.gif"  /></A>
        </td>
      </tr>
    </table></td>
  </tr>
