<? include("../../librerias/lib/@session.php"); 
	...
	$_SESSION["id_area_bus_rep"] = $_GET["id_area"];
...
<table width="100%" border="0" class="tabla_blanca_report_tarifas">
 ...
 <script type="text/javascript">
		   ...
		   function carga_grafica_detalle_tp_tarifas(tp_tarifa, tarifas_usadas){
		...
		window.parent.document.getElementById('grafica_detalle_tipo_tarifa').src="variacion_tarifas_detalle_tp_tarifa.php?tp_tarifa="+tp_tarifa+"&tarifas_usadas="+tarifas_usadas
