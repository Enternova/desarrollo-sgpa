<? 	header("Content-type: application/octet-stream");header("Content-Disposition: attachment; filename=Reporte de Montos de Aprobacion por Area.xls"); header("Pragma: no-cache"); header("Expires: 0");	 
