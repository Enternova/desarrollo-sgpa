...
<table width="100%" border="0" class="tabla_lista_resultados">
  <tr  >
    <td width="15%" align="center" class="fondo_3">Solicitud de Contratos Marco</td>
    <td width="15%" align="center" class="fondo_3">N&uacute;mero del Contrato Marco</td>
...
$query_reporte = "select * from vista_reporte_saldos_marco_1 where id_item > 0 ".$comple_sql.$sq_comple." order by id_item desc";
	...
	?>
  <tr style="cursor:pointer" class="<?=$clase?> windowPopup" onclick='window.parent.document.getElementById("div_carga_busca_sol").style.display="block";ajax_carga("../aplicaciones/reportes/lista_reporte_saldos.php?id_contrato=<?=$sel_contra[1]?>","div_carga_busca_sol")'>
