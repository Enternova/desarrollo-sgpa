...
<body>
    ...
    <div class="row">
      ...
      <div class="row">
        <div class="col s12 m3 l3">
          <a onclick="abrir_ventana('../reportes/roles_usuarios_general.php?usuario_permiso='+document.getElementById('usuario').value+'&rol='+document.getElementById('rol').value+'&estado='+document.getElementById('estado').value)" class="waves-effect waves-light btn" style="background-color: #229BFF;"><i class="material-icons left">&#xE2C0;</i>Exportar a Excel</a>
        </div>
      </div>
      <div class="row">
        <div class="col s12 m12 l12">
          <table id="data-table-proveedor" class="responsive-table striped centered" cellspacing="0" width="100%" style="">
              <thead>
                  <tr>
                      <th>
                      ...
                      <th>
                        <div class="input-field">
                          <i class="material-icons prefix">&#xE7FD;</i>
                          <input autocomplete="off" id="usuario" onkeyup="busca_usuario(this.value,'nombre_administrador')" name="usuario" type="text" class="validate" >
  ...
  <script>
    ...
    function busca_usuario(key,familia){
      $.post('busca_roles_usuarios_reporte.php', {key: key,familia:familia, usuario:$("#usuario").val(), rol:$("#rol").val(), estado:$("#estado").val()}, function(data) {
