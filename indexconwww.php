  ...
  <tr>
    ...
    <form name="ingreso" method="post" enctype="multipart/form-data">
      ...
      <table width="95%" border="0" cellpadding="2" cellspacing="2" class="tabla_borde_azul_fondo_blanco">
        ...
        <tr>
          <td width="43%" align="center" class="telefono_contacto"><div align="center">(57 1) 381 6521 Opci&oacute;n 1 - (57) 316 526 3021<br />
            E-mail
      ...
      <table width="95%" border="0" cellpadding="2" cellspacing="2" class="tabla_borde_azul_fondo_blanco">
        <tr>
          <td class="titulo_tabla_azul_sin_bordes">Chat en vivo!</td>
        </tr>
        <tr>
          <td width="43%" align="center" class="telefono_contacto"><div align="center"><!-- mibew button --><a onclick="if(navigator.userAgent.toLowerCase().indexOf('opera') != -1 &amp;&amp; window.event.preventDefault) window.event.preventDefault();this.newWindow = window.open(&#039;http://190.84.252.100/chat_enternova/client.php?locale=es&amp;style=simplicity&amp;url=&#039;+escape(document.location.href)+&#039;&amp;referrer=&#039;+escape(document.referrer), 'mibew', 'toolbar=0,scrollbars=0,location=0,status=1,menubar=0,width=640,height=480,resizable=1');this.newWindow.focus();this.newWindow.opener=window;return false;"><img src="http://190.84.252.100/chat_enternova/b.php?i=simple&amp;lang=es" border="0" alt=""/></a><!-- / mibew button --></div></td>
        </tr>
    </table>
      <br />
      <table width="95%" border="0" cellpadding="2" cellspacing="2" class="tabla_borde_azul_fondo_blanco">
